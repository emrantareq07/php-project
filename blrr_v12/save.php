...
include 'db.php';
include_once 'backend/function.php'; // Add this line
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "INSERT INTO `$table_name`(`unique_id`, `entry_date`, `recipient`, `d_number`, `attention`, `ref_number`, `send_date`, `sender`, `div_dept_office`, `subject`, `destination_drop`, `distribution_date`, `chairman_note`, `comments`, `medium`, `status`, `created_at`) 
            VALUES ('$unique_id', '$entry_date', '$recipient', '$d_number_english', '$attention', '$ref_number', '$send_date', '$sender', '$div_dept_office', '$subject', '$destination_drop', '$distribution_date', '$chairman_note', '$comments', '$medium', '$status', '$created_at')";
