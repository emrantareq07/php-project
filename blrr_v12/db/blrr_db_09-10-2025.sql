...
-- Date: Thu, 09 Oct 2025 12:22:11 +0200
...
SET autocommit=0;
INSERT INTO `chairmanfile` VALUES (1,'','2025-09-24','পরিচালক (পরিকল্পনা ও বাস্তবায়ন)','',1,'','','2025-09-24','','','www','','পরিচালক (বাণিজ্যিক),পরিচালক (অর্থ),পরিচালক (পরিকল্পনা ও বাস্তবায়ন),পরিচালক (কারিগরি ও প্রকৌশল),গবেষণা ও উৎপাদনশৈলী বিভাগ','0000-00-00','','www','','','0000-00-00 00:00:00','2025-09-24 05:53:22','2025-09-24 05:53:22'),(2,'','2025-09-24','পরিচালক (অর্থ)','',2,'','','2025-09-24','','','gg','','পরিচালক (বাণিজ্যিক),পরিচালক (অর্থ),পরিচালক (পরিকল্পনা ও বাস্তবায়ন),পরিচালক (কারিগরি ও প্রকৌশল),পরিচালক (উৎপাদন ও গবেষণা),ঊর্ধ্বতন মহাব্যবস্থাপক (প্রশাসন),কর্মচারী প্রধান','0000-00-00','','ggg','','','0000-00-00 00:00:00','2025-09-24 07:19:08','2025-09-24 07:19:08');
/*!40000 ALTER TABLE `chairmanfile` ENABLE KEYS */;
UNLOCK TABLES;
COMMIT;

-- Dumped table `chairmanfile` with 2 row(s)
--
...
-- Dumped table `dirfin` with 5 row(s)
--
...
-- Dump completed on: Thu, 09 Oct 2025 12:22:11 +0200
