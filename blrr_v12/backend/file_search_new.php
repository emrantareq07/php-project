...
<div class="container-fluid mt-1 p-2 border rounded shadow-lg">  
 <div class="row"> 
    <div class="col-sm-12">
        <h2 class="text-muted text-center"><b>ফাইল প্রাপ্তি রেজিস্টার</b> </h2>
    ...
    <div class="col-sm-3 text-center">
      <a href="addfiledashboard.php" class="btn btn-primary text-center"> <i class="fa fa-arrow-left" style="font-size:16px"></i> Back</a>     
        <hr>
