...
// Convert statistics to Bengali numbers
$total_bn = convertToBengaliNumber($total);
$implemented_bn = convertToBengaliNumber($implemented);
$ongoing_bn = convertToBengaliNumber($ongoing);
...
<!-- Statistics with Bengali Numbers -->
<div class="stats-container">
    <div class="stats-box">
    <div class="stats-label">মোট উদ্ভাবন : ' . $total_bn . ' বাস্তবায়িত : ' . $implemented_bn . ' চলমান : ' . $ongoing_bn . '</div>
...
while ($row = mysqli_fetch_assoc($result)) {
    ...
    // Convert serial number to Bengali
    $sl_bn = convertToBengaliNumber($sl);
...
// Summary row with Bengali number
$total_records_bn = convertToBengaliNumber($sl-1);
$html .= '<div style="text-align: right; margin-top: 10px; font-size: 10px; font-weight: bold;">
    মোট রেকর্ড: ' . $total_records_bn . ' টি
</div>';
