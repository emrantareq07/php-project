...
$dump = new Ifsnop\Mysqldump\Mysqldump('mysql:host=localhost;dbname=sfms_db', 'root', '');
 $dump->start($outputFile);


$dump1 = new Ifsnop\Mysqldump\Mysqldump('mysql:host=localhost;dbname=sfms_db', 'root', '');
$f=date('d-m-Y');
...
$mail->IsHTML(true);
$mail->Subject="BCIC SFMS Database Backup ".$f;
