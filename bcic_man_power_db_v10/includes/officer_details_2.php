...
function generateFactoryCombinePrintView(data) {
    ...
    printContent += `
                <div class="print-header text-center">
                    ...
                    <h5 class="mb-0">বিদ্যমান জনবলের পরিসংখ্যান : (${convertDateToBangla(data.month_name.split("'")[0].trim() + ' 01')} তারিখে)</h5>
                </div>
    `;
...
function generateCombinePrintView(monthsData) {
        ...
        <body>
            <div class="container-fluid">
                <div class="print-header">
                    ...
                    <h4 class="text-bangla">সমস্ত কারখানার সমন্বিত রিপোর্ট</h4>
    ...
    monthsData.forEach(monthData => {
        ...
        printContent += `
                    <p class="bangla-text">মোট কারখানা: ${englishToBanglaNumber(Object.keys(monthData.data.reduce((acc, record) => {
