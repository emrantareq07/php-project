    ...
    printContent += `
                <div class="print-header text-center">
                   ...
                   <h5 class="mb-1">কারখানা/প্রতিষ্ঠান/প্রকল্পের নাম : ${data.factory_name}</h5>
                    ...
                    <h6 class="mb-0">বিদ্যমান জনবলের পরিসংখ্যান : (${convertDateToBangla(data.month_name.split("'")[0].trim() + ' 01')} তারিখে)</h6>
                </div>
    `;
        ...
        <body>
            <div class="container-fluid">
                <div class="print-header">
                    ...
                    <h6 class="text-bangla">বিদ্যমান জনবলের পরিসংখ্যান</h6>
...
// <h4 class="mb-1">কারখানা/প্রতিষ্ঠান/প্রকল্পের নাম : ${data.factory_name || ''} ff</h4>
    ...
    printContent += `
                <div class="print-header text-center">
                    <h3 class="mb-0">বাংলাদেশ কেমিক্যাল ইন্ডাস্ট্রিজ কর্পোরেশন1</h3>
                    <h6 class="mb-0">বিসিআইসি ভবন, ৩০-৩১, দিলকুশা বা/এ, ঢাকা-১০০০।</h6>
                <h5 class="mb-1">কারখানা/প্রতিষ্ঠান/প্রকল্পের নাম : ${data.factory_name}</h5>                  
