    ...
    <div class="header-card">
        ...
        <div class="text-center mb-4">
            <h2 style="color: #667eea; font-weight: 700;">
                <i class="fas fa-certificate"></i> Training Evaluation Sheet (Batch-<?= htmlspecialchars($batch) ?>)
            </h2>
...
<div> <h6 class="text-center fw-bold"> Rating Scale: 1=Bad, 2=Average, 3=Good, 4=Excellent</h6></div>
