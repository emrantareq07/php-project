...
<div class="container py-5">
    <div class="card shadow-lg p-4">
        ...
        <p class="text-lowercase">Your role: <strong class="text-primary"><?= ucfirst($user_role) ?></strong> Emp ID: <?= ucfirst($user_id) ?> Email ID: <?= ucfirst($email_id) ?></p>
        ...
        <?php if ($user_role === 'sadmin'): ?>
            ...
            <ul>
                ...
                <li><a href="settings.php" style="text-decoration: none;">⚙️ Training Settings/Setup</a></li>
                 ...
                 <li><a href="training_evalution_setup.php" style="text-decoration: none;">⚙️ Training Evaluation Setup</a></li>
             ...
             <li><a href="result_by_batch.php" style="text-decoration: none;">📑  Batch Wise Result</a></li>
              <li><a href="evaluation_by_batch.php" style="text-decoration: none;">📑 Batch Wise Evaluation</a></li>
        ...
        <?php elseif ($user_role === 'user'): ?>
            ...
            <ul>
                ...
                <li><a href="my_certificates.php?email=<?= urlencode($_SESSION['user_email']); ?>" style="text-decoration: none;">🎓 Certificates & Evaluation</a></li>
