...
<select name="batch" class="form-select  me-2" required onchange="this.form.submit()">
...
<a href="dashboard.php" class="btn btn-primary float-end mb-3 ">
<i class="bi bi-arrow-left me-0"></i> Back to Dashboard
</a>
</div>
