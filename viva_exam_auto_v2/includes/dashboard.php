...
$committeeQuery = "SELECT DISTINCT committe_name FROM committee_tbl WHERE name = '$username'";
...
//     $committeeList = "'" . implode("','", $committeeNames) . "'";
//     $candidateQuery = "SELECT * FROM candidates_tbl WHERE committe_name IN ($committeeList)";
