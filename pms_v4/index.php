...
<div class="container">
    <div class="login-container"> 
        <h4 class="fw-bold text-muted katibeh-regular">BCIC Patient Management System (PMS)</h4>
      <img src="assets/img/bcic_logo.png" alt="Logo" width="100" height="100" class="mb-2">
      <p class="text-muted text-uppercase "> User Login</p>
      <div class="form-box ">
