...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    // Fetch hashed password and role from DB
...
<!-- Optional: Display login failed message -->
<?php if ($login_failed): ?>
    <p style="color:red;">Login failed! Please check your username or password.</p>
<?php endif; ?>
...
<head>
    ...
    <title>Viva Exam Automation | Login</title>
...
<div class="login-card">
    <div class="text-center mb-4">
        ...
        <h4 class="mt-2">Viva Exam Automation</h4>
