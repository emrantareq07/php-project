                    ...
                    <div class="certificate-content">
                        <div class="header-logos">
                            ...
                            <div class="header-text">
                                ...
                                <h4 class="text-primary fw-bold my-2">Ministry of Industries</h4>
                                <h4 class="text-primary fw-bold">People Republic of Bangladesh</h4>
                                <!-- <h2 class="montserrat-alternates-bold">Certificate of Achievement </h2> -->
<div style="position: relative;">
    <h2 class="montserrat-alternates-bold">Certificate of Achievement</h2>
    <h6 style="position: absolute; top: 5; right: -10px; color: #6c757d; margin: 0;">
        Serial No: <span>BCIC-ICT-DIVISION-<?= htmlspecialchars($certificate_data['batch']); ?></span>
                                ...
                                <!-- <h6 class="text-muted text-end ">Serial No: <span >BCIC-ICT-DIVISION-<?= htmlspecialchars($certificate_data['batch']); ?></span></h6> -->
                        ...
                        <p class="certificate-text lobster-two-regular mt-2">
                            <?php 
                                // Format dates as "15 September 2025"
