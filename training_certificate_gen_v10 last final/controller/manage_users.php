...
<?php
$batch = $row['batch'] ?: '-';
$color = '#' . substr(md5($batch), 0, 6); // auto color from batch name
?>
    <span class="batch-badge" style="background: <?php echo $color; ?>">
...
.batch-badge {
  ...
  <td>
    <button 
        class="btn btn-sm btn-info viewRemarksBtn" 
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header bg-info text-white">
        <h5 class="modal-title">User Remarks</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
      </div>
      <div class="modal-body">
        <p id="remarksContent" style="white-space: pre-wrap;"></p>
      </div>
...
$(document).ready(function(){
    $('.viewRemarksBtn').click(function(){
        var remarks = $(this).data('remarks') || 'No remarks available';
