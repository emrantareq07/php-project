...
if(strlen($_SESSION['alogin'])==0){   
    ...
    if(isset($_POST['update'])){
        ...
        $query->bindParam(':book_no', $book_no, PDO::PARAM_STR);
...
<!--             <div class="row mb-0 my-2">
    ...
    <div class="col-md-4">        
            ...
            <input class="form-control" type="date" name="entry_date" readonly 
                   value="<?php echo htmlentities($result->entry_date); ?>" />
        </div>
     ...
     <!--    <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input class="form-control" type="text" name="book_no" 
                   value="<?php echo htmlentities($result->book_no); ?>" required />
        </div> -->
