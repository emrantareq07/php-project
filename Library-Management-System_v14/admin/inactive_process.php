...
if(isset($_POST['inactive'])) {
    ...
    if(mysqli_num_rows($result) == 0) {
        $_SESSION['error'] = "No User found with session: " . htmlspecialchars($std_session);
        header('location:inactive_process.php');
        exit();
    }
    ...
    if($result_inactive) {
        $_SESSION['msg'] = "Successfully inactivated User with session: " . htmlspecialchars($std_session);
    } else {
...
if(isset($_POST['active'])) {
    ...
    if($result_inactive) {
        $_SESSION['msg'] = "Successfully Activated User with session: " . htmlspecialchars($std_session);
    } else {
        $_SESSION['error'] = "Update failed: " . mysqli_stmt_error($stmt);
    }
...
?>
    ...
    <div class="content-wrapper">
        <div class="container py-4">
            <div class="row mb-4">
                <div class="col-12">
                    <h2 class="fw-bold text-uppercase">User Iactive </h2>
                    <hr>
                </div>
            </div>
             <?php if($_SESSION['msg']!="") { ?>
                ...
                <div class="col-lg-6 col-md-8">
                    <div class="card  shadow-sm">
                        <div class="card-header bg-danger text-white">
                            <h5 class="card-title mb-0"><i class="fas fa-user-edit me-2"></i>User Inactive Process</h5>
                        </div>
                        <div class="card-body">
                            <form method="post">
                                <div class="mb-3">
            ...
            <hr>
                        <div class="row justify-content-center">
                                            <div class="col-12">
                    <h2 class="fw-bold text-uppercase">User Active </h2>
                    <hr>
                </div>
                <div class="col-lg-6 col-md-8">
                    <div class="card  shadow-sm">
                        <div class="card-header bg-success text-white">
                            <h5 class="card-title mb-0"><i class="fas fa-user-edit me-2"></i>User Active Process</h5>
                        </div>
                        <div class="card-body">
                            <form method="post">
                                <div class="mb-3">
