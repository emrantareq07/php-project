...
<div class="container">    
    ...
    <div class="form-group">
        <form method="POST" id="add_name">
            <div class="row">
                <div class="col-md-6">
                    <label for="StudentId">EMP ID</label>
                    <input list="StudentIdList" type="text" class="form-control StudentId" name="StudentId" placeholder="Enter EMP ID No" required oninput="fetchStudentDetails(this)">
 ...
 -->
            <div class="table-responsive mt-3">
                ...
                <input type="submit" name="submit" class="btn btn-primary" value="Issue" />
            </div>
        </form>
    </div>
</div>
