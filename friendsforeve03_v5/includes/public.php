      ...
      <div class="modal-content">
        <form id="publicForm" class="row g-3 p-3" autocomplete="off" enctype="multipart/form-data">
          ...
          <div class="modal-body">
            <div class="col-md-6"><label class="form-label required-field">Name</label><input autocomplete="on" type="text" name="name" class="form-control" required></div>
            <div class="col-md-6"><label class="form-label required-field">Mobile</label><input autocomplete="on" name="mobile" class="form-control" required inputmode="tel"></div>
            <div class="col-md-6"><label class="form-label">Alternate Mobile</label><input autocomplete="on" name="alt_mobile" class="form-control" inputmode="tel"></div>
            <div class="col-md-6"><label class="form-label">Email</label><input autocomplete="on" name="email" type="email" class="form-control"></div>
            <div class="col-md-6"><label class="form-label required-field">Occupation</label><input autocomplete="on" type="text" name="occupation" class="form-control" required></div>
            <div class="col-md-6"><label class="form-label">Jobplace</label><input name="jobplace" autocomplete="on" type="text" class="form-control"></div>
