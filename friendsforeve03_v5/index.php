...
<div class="container py-5 ">
  <div class="row justify-content-center">
    <div class="col-md-6 col-lg-5">
      <div class="card  rounded shadow border border-primary">
        <div class="card-body p-4">
          <h3 class="text-center mb-3 text-muted ">🔑 Login</h3>
          <?php echo $message; ?>
          ...
          <p class="text-center mt-3">No account? <a href="includes/register.php">Register</a></p>
        </div>
      </div>
    </div>
  </div>
