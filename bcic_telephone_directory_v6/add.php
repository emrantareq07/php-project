...
<div class="card">
 ...
 <div class="row">
	...
	<div class="col-sm-4">
    <div class="form-group">
      <label for="phone_office" class="form-label">Phone (Off.):</label>
      <input type="text" class="form-control" id="phone_office" placeholder="Enter username" name="phone_office" required>
      <div class="valid-feedback">Valid.</div>
      <div class="invalid-feedback">Please fill out this field.</div>
    </div>
	<div class="form-group">
      <label for="phone_home" class="form-label">Phone (Res.):</label>
      <input type="text" class="form-control" id="phone_home" placeholder="Enter username" name="phone_home" required>
      <div class="valid-feedback">Valid.</div>
      <div class="invalid-feedback">Please fill out this field.</div>
    </div>
	<div class="form-group">
      <label for="intercom" class="form-label">Intercom:</label>
      <input type="text" class="form-control" id="intercom" placeholder="Enter username" name="intercom" required>
      <div class="valid-feedback">Valid.</div>
      <div class="invalid-feedback">Please fill out this field.</div>
    </div>
	<div class="form-group">
      <label for="mobile" class="form-label">Mobile:</label>
      <input type="text" class="form-control" id="mobile" placeholder="Enter username" name="mobile" required>
      <div class="valid-feedback">Valid.</div>
      <div class="invalid-feedback">Please fill out this field.</div>
    </div>
    <div class="form-group">
