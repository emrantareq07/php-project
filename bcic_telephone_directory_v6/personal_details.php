...
<?php //include('../includes/header.php');?>
 ...
 <div class="container p-2 my-3 pt-3 mt-3 border shadow-lg bg-white flex-containers rounded border-primary" >
 <!--<div class="container-sm|md|lg|xl p-2 my-3 pt-3 mt-3 mx-5 border shadow-lg bg-white flex-containers rounded border-info" >-->
 	<div class="row">
	
	<div class="col-sm-12 ">
		<div class="title">	
			<span class="float-start"><a href="show_all_contact.php">
...
<table class="table table-bordered table-hover border-success align-middle table-striped p-2 my-3">
<tbody>
<tr><thead>
