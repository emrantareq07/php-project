...
<div class="container py-4">
  ...
  <div class="d-flex justify-content-between align-items-center mb-3">
    <h2>Friendsforeve03 - Contacts</h2>
    <div>
      <a href="logout.php" class="btn btn-outline-primary me-2">Logout</a>
      <a href="public.php" class="btn btn-outline-primary me-2" target="_blank">Public View</a>
      <a href="requests.php" class="btn btn-outline-primary me-2" target="_blank">Request Lists</a>
