...
if (isset($_GET['edit_id'])) {
    // Editing mode - check if other entries exist for the same month
    $editing_record_id = $_GET['edit_id'];
    $is_editing = true;
    
    // Fetch the specific record for editing first
                        ...
                        <tr>
                            <td colspan="9" class="text-end">
                                <button type="button" id="add_worker" class="btn btn-success btn-sm" 
                                    <?php echo $monthly_entry_exists && !$is_editing ? 'disabled' : ''; ?>>
                                    <i class="fa fa-plus"></i> Add Row
                                </button>
                                
                                <!-- Save New Button - Only show when NOT editing and NO monthly entry exists -->
                                ...
                                <!-- Update Record Button - Only show when editing -->
