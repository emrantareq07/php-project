...
<table class="print-table">
    <thead>
        <tr>
            ...
            <th style="width: 15%">সরাসরি নিয়োগ</th>
            <th style="width: 15%">মোট শূন্য</th>
        </tr>
    </thead>
    <tbody>
        <?php
        ...
        <tr>
            ...
            <?php endif; ?>
            <td>গ্রেড <?php echo enToBn($gradeNum); ?></td>
            <td><?php echo enToBn($grantedVal); ?></td>
            <td><?php echo enToBn($serviceVal); ?></td>
            <td><?php echo enToBn($promoVal); ?></td>
            <td><?php echo enToBn($directVal); ?></td>
            <td class="vacant-cell"><?php echo enToBn($vacantVal); ?></td>
        </tr>
        <?php
                $globalIdx++;
            endforeach;
        ...
        <tr class="subtotal-row">
            <td style="text-align: middle;"><strong><?php echo $className; ?> - উপমোট</strong></td>
            <td><strong><?php echo enToBn($classGranted); ?></strong></td>
            <td><strong><?php echo enToBn($classService); ?></strong></td>
            <td><strong><?php echo enToBn($classPromo); ?></strong></td>
            <td><strong><?php echo enToBn($classDirect); ?></strong></td>
            <td class="vacant-cell"><strong><?php echo enToBn($classVacant); ?></strong></td>
        </tr>
    ...
    <!-- <tfoot style="background-color: #e9ecef; font-weight: bold;"> -->
        <tr class="grand-total-row">
            <td class="text-center" colspan="2"><strong>সর্বমোট</strong></td>
            <td><strong><?php echo enToBn($totalGranted); ?></strong></td>
            <td><strong><?php echo enToBn($totalService); ?></strong></td>
            <td><strong><?php echo enToBn($totalPromo); ?></strong></td>
            <td><strong><?php echo enToBn($totalDirect); ?></strong></td>
            <td class="vacant-cell"><strong><?php echo enToBn($totalVacant); ?></strong></td>
        </tr>
    <!-- </tfoot> -->
</table>
...
<div class="no-print text-center mt-4" style="text-align: center; margin-top: 20px;">
