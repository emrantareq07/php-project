...
<head>
    ...
    <title>গ্রেড ভিত্তিক জনবল ব্যবস্থাপনা | CRUD with Clone</title>
...
<div class="container mt-4 mb-5">
    ...
    <div class="main-card">
        <div class="card-header">
            ...
            <small class="float-end"><i class="fas fa-info-circle"></i> শূন্য পদ = পদোন্নতিযোগ্য + সরাসরি নিয়োগযোগ্য</small>
        </div>
