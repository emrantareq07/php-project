...
<div class="sidebar d-flex flex-column" id="sidebar">
    ...
    <a href="vacant_statistics.php"><i class="fa fa-chart-line me-2"></i>Vacant Statistics</a>
    <?php  
...
<div class="main-content" id="mainContent">
    <div class="container-fluid">
        ...
        <!-- Vacant Statistics Factory-wise Table for Admin -->
        <?php if ($vacant_stats['total_records'] > 0): ?>
        <div class="records-card">
            <div class="card-header d-flex justify-content-between align-items-center flex-wrap">
                <span><i class="fas fa-chart-line me-2"></i>কারখানা অনুযায়ী শূন্য পদ পরিসংখ্যান</span>
            ...
            <div class="table-responsive">
                <table class="table table-hover mb-0">
                    ...
                    <tbody>
                        <?php foreach ($vacant_stats['factory_summary'] as $factory => $summary): 
                            $latest_entry = !empty($summary['latest_date']) ? date('d-m-Y', strtotime($summary['latest_date'])) : 'N/A';
                        ?>
                        <tr>
                            <td><strong><?php echo htmlspecialchars($factory); ?></strong></td>
                            <td><?php echo $latest_entry; ?></td>
                            <td><?php echo englishToBanglaNumber($summary['granted']); ?></td>
                            <td><?php echo englishToBanglaNumber($summary['service']); ?></td>
                            <td class="text-danger fw-bold"><?php echo englishToBanglaNumber($summary['vacant']); ?></td>
                            <td><?php echo englishToBanglaNumber($summary['records']); ?></td>
                            <td>
                                <a href="vacant_statistics.php?factory=<?php echo urlencode($factory); ?>" class="btn btn-sm btn-warning btn-action" title="দেখুন">
