...
<form method="POST" enctype="multipart/form-data" class="card p-3 mb-4" id="candidateForm">
    <div id="candidateRows">
        <div class="candidate-row border p-3 mb-3 rounded bg-white">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-2"><input type="text" name="name[]" class="form-control" placeholder="Full Name" required autocomplete="on"></div>
                <div class="col-md-2"><input type="text" name="fathers_name[]" class="form-control" placeholder="Father's Name" autocomplete="on"></div>
                <div class="col-md-2"><input type="text" name="mothers_name[]" class="form-control" placeholder="Mother's Name" autocomplete="on"></div>
                <div class="col-md-2"><input type="text" name="district[]" class="form-control" placeholder="District" autocomplete="on"></div>
                <div class="col-md-2"><input type="date" name="dob[]" class="form-control"></div>
            </div>

            <div class="row g-3 mt-2">
                <div class="col-md-3"><input type="text" name="ssc[]" class="form-control" placeholder="SSC CGPA" autocomplete="on"></div>
                <div class="col-md-3"><input type="text" name="hsc[]" class="form-control" placeholder="HSC CGPA" autocomplete="on"></div>
                <div class="col-md-3"><input type="text" name="honors[]" class="form-control" placeholder="Honors CGPA" autocomplete="on"></div>
                <div class="col-md-3"><input type="text" name="masters[]" class="form-control" placeholder="Masters CGPA" autocomplete="on"></div>
            </div>

            <div class="row g-3 mt-2">
                <div class="col-md-3"><input type="text" name="designation[]" class="form-control" placeholder="Designation" autocomplete="on"></div>
                <div class="col-md-2"><input type="number" name="written_marks[]" class="form-control" placeholder="Written Marks" ></div>
                <div class="col-md-2"><input type="number" name="viva_marks[]" class="form-control" placeholder="Viva Marks"></div>
                <div class="col-md-2">
            ...
            <div class="text-end mt-2">
                <button type="button" class="btn btn-danger btn-sm removeRow"><i class="fa fa-trash"></i> Remove</button>
            </div>
        </div>
    </div>
    ...
    <div class="d-flex justify-content-between">
        ...
        <button type="submit" name="save_all" class="btn btn-success"><i class="fa fa-save"></i> Save All</button>
        <a href="admin_dashboard.php" class="btn btn-primary"><i class="fa fa-arrow-left"></i> Back</a>
        <!-- Cancel Button -->
...
function resetForm() {
    ...
    // Replace all rows with the fresh row
    $('#candidateRows').html(freshRow);
    
    // Hide cancel button and remove edit mode styling
    $('#cancel_edit').hide();
    $('.candidate-row').removeClass('edit-mode');
