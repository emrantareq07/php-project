                ...
                <div class="card shadow border border-success border-2">
                 ...
                 <div class="mb-3">
                     <div class="form-group">
                        ...
                        <select class="form-select form-select mb-3 " name="office_type" aria-label=".form-select example" required>
                        <option value="" disabled selected>--Select--</option>
                        <!-- <option value="bcic_hq">BCIC HQ</option>
                        <option value="port_office">Port Office</option>
                        <option value="factory">Factory</option>
                        <option value="buffer">Buffer Godown</option> -->
                        <option value="bcic_hq" <?=$student['office_type'] == 'bcic_hq' ? ' selected="selected"' : '';?>>BCIC HQ</option>  
                        <option value="port_office" <?=$student['office_type'] == 'port_office' ? ' selected="selected"' : '';?>>Port Office</option>
                        <option value="factory_office" <?=$student['office_type'] == 'factory_office' ? ' selected="selected"' : '';?>>Factory</option>  
                        <option value="buffer" <?=$student['office_type'] == 'buffer' ? ' selected="selected"' : '';?>>Buffer Godown</option>
                        </select>
                    </div>
                </div> 
