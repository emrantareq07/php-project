...
if (isset($_GET['ajax']) && $_GET['ajax'] === 'production_by_date') {
    ...
    $sql = "SELECT id, factory_name, daily_amount, date
            FROM production_tbl
            WHERE date = ?
...
/*#dailySummaryModal .table thead th {
    background:#1e293b; color:#fff; font-size:12px;
    text-transform:uppercase; letter-spacing:.5px;
    vertical-align:middle; text-align:center;
}
#dailySummaryModal .table td {
    vertical-align:middle; font-size:13px; text-align:center;
}
#dailySummaryModal .text-left { text-align:left !important; }*/
        ...
        <div class="col-md-4">
            <div class="stat-card stat-import stat-clickable p-3"
                ...
                <div class="small opacity-75 mt-1">
                    ...
                    Across <?= count($importRows); ?> import allotments
                </div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-header bg-primary text-white">
        <h5 class="modal-title" id="dailySummaryModalLabel">
          <i class="fa fa-table"></i> All Buffer Summary Report
        </h5>
      ...
      <div class="modal-body p-0">
        <div class="d-flex justify-content-between align-items-center px-3 py-2 border-bottom bg-light">
          <span class="small text-muted">
            Total Buffers: <b id="summaryBufferCount">—</b>
          </span>
          <span class="small text-muted">
            <i class="fa fa-spinner fa-spin" id="summarySpinner"></i> Loading…
          </span>
        </div>
          ...
          <table class="table table-striped table-hover mb-0 align-middle">
            <thead>
              <tr>
                ...
                <th>Factory Name</th>
                <th class="text-end" style="width:180px;">Daily Amount (MT)</th>
              </tr>
            </thead>
        ...
        fetch('?ajax=production_by_date&date=' + encodeURIComponent(date))
            ...
            .then(function (data) {
                ...
                data.rows.forEach(function (row, idx) {
                    ...
                    html += '<td>' + esc(row.factory_name) + '</td>';
