    ...
    <div class="container">
        ...
        <div class="form-container">
            ...
            <form id="workRequestForm" method="POST">
                ...
                <div class="form-grid">
                    <div class="form-group">
                        <label for="w_com_division" class="required">Concerned Division</label>
                        <select id="w_com_division" name="w_com_division" required>
                            ...
                            <option value="Maintenance" <?php echo ($_POST['w_com_division'] ?? '') == 'Maintenance' ? 'selected' : ''; ?>>Maintenance</option>
                    ...
                    <div class="form-group">
                        <label for="w_com_section" class="required">Concerned Section</label>
