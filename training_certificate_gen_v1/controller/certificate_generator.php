...
<div class="certificate-container">
    <div class="certificate" id="certificate">
        <div class="certificate-content">
            ...
            <p class="certificate-text">The training program is managed by the AARC (Management Consultant) Ltd.</p>

            <div class="signatures">
                <div class="signature">
                    <?php if (isset($certificate_data['signature1'])): ?>
                    <div class="signature-img"><img src="<?php echo $certificate_data['signature1']; ?>" alt="Signature 1"></div>
                    <?php endif; ?>
                    <div class="signature-name">Dr. Md. Taibur Rahman</div>
                    <div class="signature-title">Project Director, EDGE Project</div>
                    <div class="signature-title">Joint Secretary, ICT Division</div>
                </div>
                <div class="signature">
                    <?php if (isset($certificate_data['signature2'])): ?>
                    <div class="signature-img"><img src="<?php echo $certificate_data['signature2']; ?>" alt="Signature 2"></div>
                    <?php endif; ?>
                    <div class="signature-name">Md. Abu Sayed</div>
                    <div class="signature-title">Executive Director</div>
                    <div class="signature-title">Bangladesh Computer Council</div>
                </div>
            </div>
            <!-- Footer Border -->
...
function downloadCertificate() {
    ...
    const opt = {
        ...
        html2canvas: { scale: 3, useCORS: true, logging: true, allowTaint: true, backgroundColor: null },
