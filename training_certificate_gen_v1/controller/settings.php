                ...
                <div class="card-body">
                    <form id="trainingForm" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <label class="form-label required-field">Ministry</label>
                                <input type="text" class="form-control" name="ministry1" required
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" name="name2"
                                       value="<?= htmlspecialchars($edit_data['name2'] ?? ''); ?>">
                            </div>
                            <div class="col-md-6">
                                <label class="form-label">Designation</label>
                                <input type="text" class="form-control" name="designation2"
                                       value="<?= htmlspecialchars($edit_data['designation2'] ?? ''); ?>">
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" name="office2"
                                       value="<?= htmlspecialchars($edit_data['office2'] ?? ''); ?>">
                            </div>
                            <div class="col-md-6">
