                ...
                <div class="form-grid">
                    ...
                    <div class="form-group">
                        ...
                        <select id="division" name="division" required>
                            ...
                            <option value="Maintenance" <?php echo $user['division'] == 'Maintenance' ? 'selected' : ''; ?>>Maintenance</option>
                            <option value="Other" <?php echo $user['division'] == 'Other' ? 'selected' : ''; ?>>Other</option>
                        </select>
                    </div>
                </div>
