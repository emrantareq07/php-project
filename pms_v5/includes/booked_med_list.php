...
try {
    ...
    $stmt = $conn->prepare("
        SELECT id, emp_id, medicine, advice, diseases, date, created_at, updated_at
        FROM special_med_tbl
        WHERE emp_id = :emp_id
                    ...
                    <div class="card prescription-card h-100">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            ...
                            <span class="badge bg-primary badge-prescription">
                                <?= $item_count-1 ?> item<?= $item_count != 1 ? 's' : '' ?>
                            </span>
                        </div>
                        <div class="card-body">
                        ...
                        <div class="card-footer bg-transparent border-top-0">
                            <div class="d-flex justify-content-between">
                                ...
                                <div class="no-print">
                                    <a href="booked_med_print.php?id=<?= $prescription['id'] ?>" 
                                       target="_blank" class="btn btn-sm btn-outline-secondary me-2">
                                        <i class="fas fa-print me-1"></i> Print
                                    </a>
                                    <a href="booked_med_entry.php?id=<?= urlencode($emp_id) ?>&edit=<?= $prescription['id'] ?>" 
                                       class="btn btn-sm btn-outline-warning me-2">
                                        <i class="fas fa-edit me-1"></i> Edit
                                    </a>
                                    <a href="booked_med_delete.php?id=<?= $prescription['id'] ?>&emp_id=<?= urlencode($emp_id) ?>" 
