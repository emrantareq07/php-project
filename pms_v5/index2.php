...
if(isset($_POST['login'])){
  ...
  if ($_SESSION['user_type'] == 'user') {
    ...
    // For success
    if ($query_run) {     
       echo "<script>window.location.href='includes/dashboard.php?code=" . $_SESSION['code'] . "'</script>";
    } else {
...
elseif($_SESSION['username'] == 'pharmacist'){
    ...
    // For success
    if ($query_run) {     
       echo "<script>window.location.href='includes/pharmacist_dashboard.php?code=" . $_SESSION['code'] . "'</script>";
    } else {
        echo "Error: " . mysqli_error($conn);
          } 
