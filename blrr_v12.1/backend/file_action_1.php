...
case 'save':
    ...
    if($id>0){
        ...
        if($stmt){
            $stmt->bind_param("sssssisssssi", $entry_date, $recipient, $immediate_sender_office,$div_dept_office, $section_dept, $d_number, $div_sign_date,$sign_date, $subject, $destination_dropfile, $comments, $id);
            if($stmt->execute()){
        ...
        if($stmt){
            $stmt->bind_param("sssssisssss", $entry_date, $recipient, $immediate_sender_office,$div_dept_office, $section_dept, $d_number, $div_sign_date,$sign_date, $subject, $destination_dropfile, $comments);
            if($stmt->execute()){
