        ...
        <body>
            <div class="container-fluid">
                <div class="print-header">
                    ...
                    <h4 class="text-bangla">কারখানা/প্রতিষ্ঠান/প্রকল্পের নাম : সমন্বিত রিপোর্ট</h4>
            ...
            printContent += `
                <div style="margin-bottom: 15px;">
                    <table class="factory-table">
                        <thead>
                            <tr>
                                <th colspan="7" style="background: #f8f9fa; text-align: center;" class="bangla-text">
...
// Function to generate single record print view in Bangla
function generateSinglePrintView(data) {
            ...
            <div class="container">
                ...
                <table class="detail-table">
                    ...
                    <tr>
                        ...
                        <td class="bangla-text">${data.created_at ? convertDateToBangla(data.created_at.split(' ')[0]) : ''}</td>
                    </tr>
                    <tr>
                        <th class="bangla-text">হালনাগাদের তারিখ</th>
                        <td class="bangla-text">${data.updated_at ? convertDateToBangla(data.updated_at.split(' ')[0]) : ''}</td>
                    </tr>
                </table>
    `;
    ...
    if (designations.length > 0) {
        ...
        designations.forEach((designation, index) => {
            ...
            printContent += `
                <tr>
                    ...
                    <td class="bangla-text">${designation.trim()}</td>
        ...
        printContent += `
                <tr class="total-row">
                    <td colspan="3" class="bangla-text"><strong>মোট</strong></td>
                    <td class="bangla-number"><strong>${englishToBanglaNumber(totalSanctioned)}</strong></td>
                    <td class="bangla-number"><strong>${englishToBanglaNumber(totalMale)}</strong></td>
                    <td class="bangla-number"><strong>${englishToBanglaNumber(totalFemale)}</strong></td>
                    <td class="bangla-number"><strong>${englishToBanglaNumber(grandTotal)}</strong></td>
