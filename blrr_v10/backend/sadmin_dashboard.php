...
$user_type=$_SESSION['user_type'];//sadmin
		...
		<div class="table-title">
			<div class="row">
				<div class="col-sm-3">
					...
					<span class="text-primary fw-bold"><small>Office : [--<?php echo $office; ?>--]</small></span>
					<p class="text-warning fw-bold"><small>Logged In As a : [--<?php echo $user_type; ?>--]</small></p>
				</div>
				<div class="col-sm-9 text-end">
					<?php
					if($user_type=='sadmin'){   
						?>
						<!-- <a href="manage_user.php?username=<?=$_SESSION['username']?>" class="btn btn-outline-warning"><i class="fa fa-edit" style="font-size:15px;color:black"></i> Manage User </a>
						<a href="manage_user.php?username=<?=$_SESSION['username']?>" class="btn btn-outline-info"><i class="fa fa-download" style="font-size:15px;color:black"></i> Download Database </a> -->

						  <div class="d-flex justify-content-end">
					        <a href="manage_user.php?username=<?=$_SESSION['username']?>" class="btn btn-outline-success me-2">
