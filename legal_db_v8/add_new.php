    ...
    <div class="row">
      <div class="col col-sm-12">
          <div class="card">
              ...
              <div class="row">
          <div class="col col-sm-8"><h2 class="float-left text-muted text-uppercase">বিসিআইসি মামলার ডাটাবেস </h2></div>
  ...
  <div class="modal-dialog modal-lg">
      <div class="modal-content">
          <div class="modal-header text-center">
              <h4 class="col-12 modal-title text-muted text-uppercase" id="userCrudModal"> নতুন মামলার তথ্য এন্ট্রি করুন</h4>
             ...
             <div class="row my-2">
              ...
              <div class="col">
                ...
                <div class="form-group"><label for="lower_name_address">আইনজীবীর নাম ও ঠিকানা</label>
                  <textarea class="form-control" placeholder="আইনজীবীর নাম ও ঠিকানা" rows="2" id="lower_name_address" value="" name="lower_name_address" ></textarea>
      ...
      <div class="modal-content">
          ...
          <div class="modal-footer">
            <span class="text-center text-muted">
              <small>Design & Developed By ICT Division, BCIC.</small>
            </span>
...
$(document).on('click', '.view', function(){
    ...
    $.ajax({
        ...
        success: function(data){
            ...
            window.location.href = 'edit_legal_data.php?id=' + encodedId;
        },
