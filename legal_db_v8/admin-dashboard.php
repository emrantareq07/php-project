...
<div class="container-fluid mt-3">
    <div class="row">
      <div class="col-sm-4"><h2 class="text-secondary display-4 text-white nosifer-regular"><b>BCIC LEGAL AFFAIRS</b></h2></div>
      <div class="col-sm-8">

        <ul class="nav float-end">
          <li class="nav-item"><a class="nav-link text-white" href="about.php?val=2">ABOUT BCIC</a></li>
          <li class="nav-item"><a class="nav-link text-white" href="add_new.php">CASE DETAILS</a></li>
          <li class="nav-item">
             <div class="dropdown">
