...
try {
    ...
    $fees = $conn->query("SELECT * FROM fee_mgtm ORDER BY id DESC")->fetchAll(PDO::FETCH_ASSOC);
...
<div class="container mt-4">
    <div class="d-flex justify-content-between align-items-center mb-3 no-print">
        <h4>Morning Glory Fee Management</h4>
        <div>
    ...
    <table id="feeTable" class="table table-bordered table-striped">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="fee-details"><?= htmlspecialchars(str_replace(",", "\n", $fee['fee_types'])) ?></td>
                <td class="fee-details"><?= htmlspecialchars(str_replace(",", "\n", $fee['actual_fee'])) ?></td>
                <td class="fee-details"><?= htmlspecialchars(str_replace(",", "\n", $fee['payment'])) ?></td>
                <td class="fee-details"><?= htmlspecialchars(str_replace(",", "\n", $fee['due'])) ?></td>
