...
<div class="container mt-3">  
  <div class="row">
    ...
    <div class="col-sm-4 border rounded shadow-lg border-primary"><h2 class="text-uppercase text-center">Add Divsion/Department</h2>
     <?php
    if(@$_GET['updated'])
    {?>
...
<!--     <div class="form-floating mt-3 mb-3">
  ...
  <br>
    ...
    <div class="col-sm-4">
      <a href="../dashboard.php" class="btn btn-outline-info float-start mt-5">Previous Page</a>
    </div>
