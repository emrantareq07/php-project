...
<head>
  ...
  <style>
    body {
      background: linear-gradient(135deg, #6434eb, #6434eb);
      height: 100vh;
      display: flex;
...
<body>
  <div class="login-container">
    <div class="logo-container">
      <h5 class="text-center m-0 fw-bold text-muted text-uppercase "> ICT Maintenance Records</h5>
    <h6 class="text-center m-0 fw-bold text-muted text-uppercase mb-2"> ICT Division, BCIC.</h6>
