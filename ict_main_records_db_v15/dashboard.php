        ...
        <div class="col-12">
            <div class="d-flex flex-wrap gap-2 mb-2">
                ...
                <div class="d-flex flex-wrap gap-2 ms-auto">
                    <a href="main_dashboard.php" class="btn btn-custom">
                        <i class="fa fa-home me-1"></i> Home
                    </a>
                    <button class="btn btn-custom-success text-white" data-bs-toggle="modal" data-bs-target="#addModal">
                        <i class="fa fa-plus-circle me-1"></i> Add Record
                    </button>
                    <a href="dateRange_searching.php" class="btn btn-custom">
                        <i class="fa fa-search me-1"></i> Search
                    </a>
                    <form id="downloadForm" action="download_db.php" method="post" class="m-0">
...
<div class="modal fade" id="editModal" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <!-- <div class="modal-header bg-warning" style="background: linear-gradient(45deg, #f72585, #b5179e); color: white;"> -->
...
$(document).ready(function() {
    var table = $('#recordsTable').DataTable({
       ...
       '<"row"<"col-12"tr>>' +
       '<"row mt-0"<"col-md-5"i><"col-md-7"p>>',
