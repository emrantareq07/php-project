      ...
      <div class="row ">    
        <div class="card-body my-0">
            <div class="form-group" >
                ...
                <select class="form-control chosen-select custom-chosen-container" id="destination_drop" data-placeholder="Select Destination" name="destination_drop[]" multiple="multiple" multiple class="chosen-select"> 
                    <?php      
