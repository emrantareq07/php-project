$(document).on('click', '#btn-add', function (e) {
    ...
    $('#destination_drop option:selected').each(function () {
        selectedDestinations.push($(this).val());
    });

    // Set the value of the hidden input
    $('#selected_destinations').val(selectedDestinations.join(','));
    ...
    $.ajax({
        ...
        success: function (dataResult) {
            console.log("Server Response:", dataResult); // Debugging: Log server response
