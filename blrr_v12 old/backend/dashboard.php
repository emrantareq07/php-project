...
<div class="container-fluid">
    <div class="table-wrapper border border-muted rounded shadow p-2 my-1">  
        <div class="container my-1">  
            ...
            <a href="show_all.php?table_name=<?= $_SESSION['table_name'] ?>" class="btn btn-outline-success d-inline-block mb-2">
            ...
            <?php if ($user_type == 'user' && ($office_title == 'division' || $office_title == 'director' || $office_title == 'chairman')) { ?>
                <a href="incoming_letter.php" class="btn btn-outline-success position-relative d-inline-block mb-2">
            ...
            <a href="show_all_old.php?table_name=<?= $_SESSION['table_name'] ?>" class="btn btn-outline-success d-inline-block mb-2">
                <i class="fa fa-file-archive-o" style="font-size:16px;color:red"></i> <span>Show Old Docs</span>
            </a>
            <a href="search_new.php?table_name=<?= $_SESSION['table_name'] ?>&val=987" class="btn btn-outline-primary d-inline-block mb-2">
                <i class="fa fa-search" style="font-size:16px"></i> <span>Search</span>
            </a>

            <?php if ($user_type == 'sadmin') { ?>
                <a href="manage_user.php?username=<?= $_SESSION['username'] ?>" class="btn btn-warning d-inline-block mb-2">
