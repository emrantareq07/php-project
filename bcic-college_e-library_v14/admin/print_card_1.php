...
$sql = "SELECT * FROM tblstudents WHERE StudentId = '0001' LIMIT 1";
...
$std_session = $result->std_session;
...
<html lang="en">
  ...
  <body class="p-3 m-0 border-0 bd-example m-0 border-0">
    <div class="container">
      <h1 class="text-center mb-4">Library Card Generator</h1>
    ...
    <div id="card-template" style="display: none;">
      <div class="card h-100">
        ...
        <div class="d-flex align-items-center p-3 me-4">
          <img src="assets/img/Seal_of_BCIC_College.png" alt="Logo" width="60" height="60" class="me-2 ms-2 " id="logo">
          <div>
            <h4 class="mb-0 fw-bold text-uppercase p-0 aladin-regular">BCIC College</h4>
            <small class="trochut-regular p-0">Zoo Road, Mirpur, Dhaka-1226</small><br>
            <small class="trochut-regular p-0">Website: bciccollege.edu.bd</small>
          </div>
        </div>

        <div class="text-center mb-3">
          <span class="badge bg-gradient bg-success text-white fw-bold px-4 py-2 rounded-pill shadow righteous-regular fs-5 " id="librarycard_text">
            📚 Library Card
          </span>
        </div>
        ...
        <div class="card-body bg-light bg-gradient rounded shadow-lg akaya-kanadaka-regular"> 
          <!-- Left-aligned Text -->
          <h5 class="card-title text-body-secondary ">Card No.: <?php echo $StudentId; ?></h5>
          <h5 class="card-title text-body-secondary">Validity Date: <?php echo $std_session; ?></h5>
          <h5 class="card-title text-body-secondary">Student Name: <?php echo $FullName; ?></h5>
          <h5 class="card-title text-body-secondary">Class: <?php echo $result->std_class; ?></h5>
<h5 class="card-title text-body-secondary d-inline-block me-3">Section: <?php echo $result->std_section; ?></h5>
<h5 class="card-title text-body-secondary d-inline-block">Division: <?php echo $result->std_group; ?></h5>
          <h5 class="card-title text-body-secondary ">Roll No.:<?php echo $StudentId; ?></h5>
          <h5 class="card-title text-body-secondary d-inline-block me-3">Session: <?php echo $std_session; ?></h5>
        </div>

        <div class="card-footer text-center">
          <small class="text-body-secondary">Issued on <?php echo date('d M Y'); ?></small>
        </div>
      </div>
    </div>
