...
SET autocommit=0;
INSERT INTO `chairman` VALUES (17,'2024-09-15','16:04','test 44','','2324234','5435','https://chatgpt.com/c/66e2ae4e-e7a0-8009-9336-9fdc2e7fc5d4','','Conference Room','Complete','September','2024-09-15'),(18,'2024-09-15','19:00','Test 2','','fdsf','dsf','','','Conference Room','Complete','September','2024-09-15'),(19,'2024-09-15','18:06','Test 444','','444','44444','','','Conference Room','Complete','September','2024-09-15'),(20,'2024-09-16','11:02','Test ','','2324234','5435','','','Conference Room','Complete','September','2024-09-15'),(21,'2024-09-18','15:00','test1','','345865','1234','','','Conference Room','Complete','September','2024-09-18'),(22,'2024-12-09','17:00','test 2','','','','','','Conference Room','Complete','December','2024-09-18'),(23,'2024-09-18','17:00','ttest','','','','','','Conference Room','Complete','September','2024-09-18'),(24,'2024-09-18','17:00','testv 33','','','','','','Conference Room','Complete','September','2024-09-18'),(25,'2024-09-18','17:00','test 55','','','','','','Conference Room','Complete','September','2024-09-18'),(26,'2024-09-19','12:00','About Lean Management System Online Meeting.','Dir (PI)','843 5828 3298','bcic','https://us02web.zoom.us/j/84358283298?pwd=QzW1yGwaNVJmQpb1boOKbzufkGViif.1','চেয়ারম্যান, বিসিআইসি','Conference Room','Incomplete','September','2024-09-19'),(27,'2024-09-19','16:00','২০২৪-২০২৫ থেকে ২০২৬-২০২৭ অর্থবছর পর্যন্ত সময়ের জন্য বিসিআইসি প্রধান কার্যালয়ে সার্বক্ষণিক টেকনিশিয়ান রেখে অধিযাচন অনুযায়ী মালামাল সরবরাহ এবং','','','','','','Conference Room','Incomplete','September','2024-09-19'),(28,'2024-09-19','17:00','ফেডারেশন অব বিসিআইসি অফিসার্স ওয়েলফেয়ার এসোসিয়েশন এর সভাপতি জনাব মোঃ দেলোয়ার হোসেনের নেতৃত্বে বিসিআইসি প্রধান কার্যালয়','পরিচালক (বাণিজ্যিক)','345865','1234','https://us02web.zoom.us/j/81073703007?pwd=1uKK4r7DcahWBYaSQNpLaQDWsaMNZx.1','চেয়ারম্যান, বিসিআইসি','Conference Room','Incomplete','September','2024-09-19'),(29,'2024-09-19','16:12','JFCL board','Dir TE','','','','চেয়ারম্যান, বিসিআইসি','Board Room','Incomplete','September','2024-09-19'),(30,'2024-09-19','17:14','Test ','পরিচালক (বাণিজ্যিক)','345865','1234','https://us02web.zoom.us/j/84358283298?pwd=QzW1yGwaNVJmQpb1boOKbzufkGViif.1','চেয়ারম্যান, বিসিআইসি','Conference Room','Incomplete','September','2024-09-19');
/*!40000 ALTER TABLE `chairman` ENABLE KEYS */;
UNLOCK TABLES;
COMMIT;

-- Dumped table `chairman` with 14 row(s)
--
...
SET autocommit=0;
INSERT INTO `dir_com` VALUES (1,'2024-09-18','10:00','SFCL test 1','Dir Techinal','','','','Chairman BCIC','Conference Room','Complete','September','2024-09-19');
/*!40000 ALTER TABLE `dir_com` ENABLE KEYS */;
UNLOCK TABLES;
COMMIT;

-- Dumped table `dir_com` with 1 row(s)
--
...
-- Dump completed on: Thu, 19 Sep 2024 12:30:44 +0200
