...
<div id="printableArea">  
    <table class="table table-bordered table-striped table-hover ">
      <thead class="table-primary text-center">
        <tr>
          <th>#</th>
          <th>Month</th>
          <th>Actual Bill (HR)<span style="font-size: 1.2em;">৳</span></th>
    ...
    <i class="fa fa-info-circle receipt_for_tenants" data-toggle="tooltip"
...
<div id="viewEmployeeModal_tenants" class="modal fade">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
          ...
          <div class="modal-body" id="printableArea_ind_tenants">
            <div style="text-align:center;" class="div2">
              ...
              <h6 class="text-decoration-none" id="month_u"></h6>
              <!-- <h6 class="mb-0 badge bg-danger">Customer Copy</h6> -->
              <!-- <h5 class="text-decoration-none mb-0"  style="margin-bottom:0px;">[--<?php ?>--]</h5> -->
            </div>  
          ...
          <table class="table table-bordered">
            ...
            <th class="text-center">House Rent </th>
                <th class="text-center" id="actual_hr_u"></th>
                <!-- <th id="hr_in_u"></th> -->
                <th  class="text-center" id="hr_outs_u"></th>        
          </tr>
          <tr> 
                <th class="text-center">Water Bill </th>
                <th class="text-center" id="actual_wb_u"></th>
                <!-- <th id="wasa_in_u"></th> -->
                <th class="text-center" id="wasa_outs_u"></th>
          </tr>
          <tr> 
                <th class="text-center">Electricity Bill </th>
                <th class="text-center" id="actual_eb_u"></th>
                <!-- <th id="eb_in_u"></th> -->
                <th class="text-center" id="eb_outs_u"></th>
          </tr>
          <tr> 
               <th class="text-center ">Gas Bill</th>
                <th class="text-center" id="actual_gb_u"></th>
                <!-- <th id="eb_in_u"></th> -->
                <th class="text-center" id="gb_outs_u"></th>
          </tr>
        ...
        <tr class="table-secondary">
            <th class="text-center ">Net Payable/Grand Total (TK): </th>   
                <th class="text-center" id="grand_total_u" colspan="2" class="border-0" ></th>
                <!-- <th id="wasa_total_u"></th> -->
                <!-- <th id="eb_total_u"></th> -->
          </tr>        
         <tr rowspan="2" class="border-0" ><th colspan="3" class="border-0"></th> </tr> 
       ...
       <tr class="border-0">
        <th colspan="3" class="border-0" style="height: 40px;"></th> <!-- You can adjust the height as needed -->
           ...
           <tr class="border-0">
        <td colspan="3" class="border-0" style="height: 40px;">CC TO: <br>1. Controller of Accounts, BCIC, Dhaka<br> 2. Customer Copy <br> 3. Office Copy</td> 
        ...
        <div class="modal-footer">
            ...
            <button type="button" class="btn btn-danger" id="print_ind_tenants"><i class="fa fa-print" style="font-size:16px"></i> Print</button>
            </div>
            </form>
        </div>
    </div>
...
$(document).on('click', '.receipt_for_tenants', function() {
    ...
    var date_vat = $(this).data("date_vat");
     ...
     var hr_total=actual_hr+actual_wb+actual_eb+actual_gb;
     var wasa_total=hr_in+wasa_in+eb_in+gb_in;
     var eb_total=hr_outs+wasa_outs+eb_outs+gb_outs;
...
document.getElementById('print_ind_tenants').addEventListener('click', function () {
    ...
    const labels = ["Customer Copy", "CA Copy", "Pay Copy"];
    ...
    labels.forEach(label => {
        // Insert the label into the original content
        const copyContent = `
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
          ...
          <table class="table table-bordered">
             ...
             <tr> 
            <th>House Rent (TK)</th>
                <th id="actual_hr_uo"></th>
                <th id="hr_in_uo"></th>
                <th id="hr_outs_uo"></th>        
          </tr>
          <tr> 
                <th>Water Bill (TK)</th>
                <th id="actual_wb_uo"></th>
                <th id="wasa_in_uo"></th>
                <th id="wasa_outs_uo"></th>
          </tr>
          <tr> 
                <th>Electricity Bill (TK)</th>
                <th id="actual_eb_uo"></th>
                <th id="eb_in_uo"></th>
                <th id="eb_outs_uo"></th>
          </tr>
           <tr> 
          ...
          <tr>
            <th>Total (TK): </th>   
                <th id="hr_total_uo"></th>
                <th id="wasa_total_uo"></th>
                <th id="eb_total_uo"></th>
          </tr>
         <tr rowspan="2" class="border-0" ><th colspan="4" class="border-0"></th> </tr> 
            <tr>
             ...
             <tr>
                <th>Challan No (Tax):</th>
                <th id="challan_no_tax_uo"></th>
                <th>Challan No (VAT):</th>
                <th id="challa_no_vat_uo"></th>
            </tr>
            <tr>
                <th>Challan Date (Tax):</th>
                <th id="date_tax_uo"></th>
                <th>Challan Date (VAT):</th>
                <th id="date_vat_uo"></th>
            </tr>
       <tr class="border-0">
...
$(document).on('click', '.viewothers', function() {
    ...
    var date_vat = $(this).data("date_vat");
     ...
     var hr_total=actual_hr+actual_wb+actual_eb;
     var wasa_total=hr_in+wasa_in+eb_in;
     var eb_total=hr_outs+wasa_outs+eb_outs;
     var dateObj = new Date(date);
