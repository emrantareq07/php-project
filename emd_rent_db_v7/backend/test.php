...
<section class="top-content bb d-flex justify-content-center align-items-center">
    <div class="top-center text-center">
        <img src="images/bcic_logo.png" alt="BCIC Logo" style="width:80px; height:auto;">
...
<!--                    <h5 class="text-decoration-none" id="tenants_name_u">aaa</h5>
          <h6 class="text-decoration-none badge bg-primary" id="month_u">aaa</h6> -->
