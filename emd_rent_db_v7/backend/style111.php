      ...
      <div style="page-break-after: always; margin: 0; padding: 15px; border: 2px solid gray; border-radius: 10px;">
                ...
                ${originalContent}
                 ...
                 <div style="text-align: center; margin-top:28px; margin-bottom: 1px; font-size: 0.9rem;">
                <hr>
...
<section>
    <div class="text-left">
        <div style="margin-left:40px;">
            ...
            <span id="">Director/MD/Proprietor</span><br> 
        ...
        <tr class="border-0">
        <th colspan="2" class="border-0" style="height:30px;"></th> <!-- You can adjust the height as needed -->
        </tr>
        <tr class="table-secondary ">
            <td class="text-center p-0 fw-bold">In word: </td>   
                <td class="text-center p-0 fw-bold" id="grand_total_u" class="border-0" ></td>
       ...
       <tr class="border-0">
        <th colspan="2" class="border-0" style="height: 40px;"></th> 
         ...
         <tr rowspan="2" class="border-0">
             ...
             <th class="border-0 border-top text-right" style="text-align: right;">
    ACA/DCA, EMD<br>For General Manager (EMD)
          </th>
            </tr>
             <!-- <tr rowspan="2" class="border-0" ><th colspan="2" class="border-0"></th> </tr>  -->
           <tr class="border-0">
        <td colspan="2" class="border-0" style="height: 20px;"><b>CC TO: </b><br>1. Controller of Accounts, BCIC, Dhaka<br> 2. Customer Copy <br> 3. Office Copy</td> 
        </tr> 
        </tbody>
      </table> 
        </div>
