...
<div id="viewEmployeeModal_tenants" class="modal fade">
    <div class="modal-dialog modal-lg">
          ...
          <div class="modal-body" id="printableArea_ind_tenants">
            ...
            <div style="text-align:center; display: flex; align-items: center; justify-content: center;" class="div2">
                ...
                <!-- Image with minimized top margin -->
                 <img src="images/bcic_logo.png" alt="BCIC Logo" style="width:80px; height:auto; margin-right:2px; 
                margin-top: -15px;">            
                <!-- Header text on the right side -->
                <div>
                    <h5 >BANGLADESH CHEMICAL INDUSTRIES CORPORATION</h5>
                    <h5 class="text-decoration-none righteous-regular" m>Estate Management Department (EMD)</h5>
        ...
        <tr class="border-0">
        <th colspan="2" class="border-0" style="height: 40px;"></th> <!-- You can adjust the height as needed -->
        </tr>
        <tr class="table-secondary ">
         ...
         <tr rowspan="2" class="border-0" ><th colspan="2" class="border-0"></th> </tr>             
       <tr class="border-0">
        <th colspan="2" class="border-0" style="height: 70px;"></th> <!-- You can adjust the height as needed -->
        </tr>           
            <tr rowspan="2" class="border-0">
             ...
             <th class="border-0 border-top text-center ">ACA/DCA, EMD<br>For General Manager (EMD)</th>
            </tr>
             <tr rowspan="2" class="border-0" ><th colspan="2" class="border-0"></th> </tr> 
           <tr class="border-0">
        <td colspan="2" class="border-0" style="height: 60px;"><b>CC TO: </b><br>1. Controller of Accounts, BCIC, Dhaka<br> 2. Customer Copy <br> 3. Office Copy</td> 
        </tr> 
        </tbody>
      </table> 
            </div>
