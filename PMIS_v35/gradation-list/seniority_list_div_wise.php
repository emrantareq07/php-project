...
<div class="card">
 ...
 <div class="row">
  ...
  <div class="watermarked">
    <img class="mx-auto d-block my-0 pt-0 watermark" src="../images/bcic.jpg" width="70" height="70"/>
  </div>
<!--navs and pills-->
 <ul class="nav nav-tabs" role="tablist">
    <li class="nav-item">
      <a class="nav-link active" data-bs-toggle="tab" href="#home">Home</a>
        ...
        <li class="nav-item">
      <a class="nav-link" data-bs-toggle="tab" href="#menu1">Officers List Division Wise </a>
    </li>
    <li class="nav-item">
      <a class="nav-link" data-bs-toggle="tab" href="#menu2">Chairman Secretariat </a>
    </li>
    <li class="nav-item">
      <a class="nav-link" data-bs-toggle="tab" href="#menu2">Dir(Com.)</a>
    </li>
    <li class="nav-item">
      <a class="nav-link" data-bs-toggle="tab" href="#menu3">Dir(Com.)</a>
    </li>
        <li class="nav-item">
  ...
  <div class="tab-content">
    <div id="home" class="container tab-pane active te"><br>
     ...
     <div id="menu1" class="container tab-pane fade"><br>
      <h3>Officers List Division wise</h3>
      <h4 class=" float-center text-center">
        <div class="input-group gap-2 gx-2 align-items-center text-center" style="display: flex; justify-content: space-around; ">
          <form method="POST" action="create_pdf_chairman_secretariat.php" target="_blank">  
               <!--<input type="submit" name="create_pdf" class="btn btn-danger" value="Print" /> -->
          <button type="submit" name="create_pdf" class="btn btn-success"><i class="fa fa-file-pdf-o" style="font-size:20px;color:white"></i> Chairman Secretariat  </button>
               
          </form>
           <form method="POST" action="create_pdf_chairman_secretariat.php" target="_blank">  
               <!--<input type="submit" name="create_pdf" class="btn btn-danger" value="Print" /> -->
          <button type="submit" name="create_pdf" class="btn btn-success"><i class="fa fa-file-pdf-o" style="font-size:20px;color:white"></i> Dir(Com) Cell </button>
               
          </form>
        </div>
        <hr class="">
        <a href="chairman_secretariat.php" target="_blank" class="btn btn-success">Chairman Secretariat </a>
        <a href="#" class="btn btn-success">Dir(Com) Cell</a>
        <a href="#" class="btn btn-success">Dir(Fin) Cell</a>
        <a href="#" class="btn btn-success text-white">Dir(PI) Cell</a>
        <a href="#" class="btn btn-secondary text-white">Dir(Prod) Cell</a>
        <a href="#" class="btn btn-secondary text-white"> Dir(TE) Cell</a>
        <a href="#" class="btn btn-secondary text-white">Sr. GM Cell</a>
        <hr class="">
        <a href="#" class="btn btn-secondary text-white">Personnel Division</a>
      <a href="#" class="btn btn-secondary text-white"> ICT Division</a>
      <a href="#" class="btn btn-secondary text-white">Purchase Division</a>
...
<a href="#" class="btn btn-info text-dark"> Manager (ICT)</a>
  ...
  <a href="#" class="btn btn-warning text-dark">Print Seniority List</a> -->
  <hr class="">
<a href="../bio-data/bio-data_and_gradation_list.php" class="btn btn-primary text-white">Previous Page</a>
