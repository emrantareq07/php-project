...
<?php include_once('navbar.php');?>
	<div class="container border shadow rounded pt-3 my-2">
	  <!-- Content here --> 
	  <div class="row"><h1 class='text-center my-1 text-uppercase text-secondary'>Welcome, Admin!</h1>
    ...
    $sql="SELECT * From users_tbl where status ='pending' and role='user' order by id ASC";
