...
?>
    ...
    <div class="container  mt-2 p-1 my-1 border shadow-lg rounded bg-white" onload='document.form1.fathersName.focus()'>
    	...
    	<div class="panel-body">
        	...
        	<form method="POST" id="form1" name="form1" action="update_personal_info.php" enctype="multipart/form-data" accept-charset="UTF-8">
            	<fieldset>
					<!-- First Column-->
				<div class="row">
				<div class="col-sm-3"> 
					...
					<div class="form-group"><label for="blood_group">Blood Group:</label>
						...
						<option value="A+" <?=$maritial_status == 'A+' ? ' selected="selected"' : '';?> >A+</option>
				...
				<div class="col-sm-3"> <center><button type="submit" id="submit" name="submit" class="btn btn-primary"><span class="glyphicon glyphicon-floppy-disk"></span> Save</button>  
				 <h4><a class="btn btn-primary" href="../view/view_profile_details.php?emp_id=<?php echo $_SESSION['emp_id'] ?>"> Previous page </a></h4></center> 
				</div>
