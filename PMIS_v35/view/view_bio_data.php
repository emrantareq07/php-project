...
<div class="container-fluid p-2 my-1 border shadow  bg-light rounded">
 ...
 width=\"130\" height=\"130\" src=\"".'./images/'.$row['image']."\">&nbsp; </center>";
      ...
      <div class="col-sm-5 "><!--2nd column-->
        ...
        <a href="view_users.php"  class="btn btn-success"><i class="fa fa-arrow-left" aria-hidden="true"></i> Previous </a>
...
<hr style="color:#4e0ba1;">
    ...
    <div class="accordion accordion-flush border mt-2" id="accordionFlushExample">
...
?>
      ...
      <div class="accordion-item">
        <h2 class="accordion-header" id="flush-headingThree">
          <button class="accordion-button collapsed bg-warning text-white" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseThree" aria-expanded="false" aria-controls="flush-collapseThree">
...
?>
        ...
        <h2 class="accordion-header" id="flush-headingFive">
          <button class="accordion-button collapsed bg-info text-white" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseFive" aria-expanded="false" aria-controls="flush-collapseFive">
...
?>
        ...
        <h2 class="accordion-header" id="flush-headingSeven">
          <button class="accordion-button collapsed bg-success text-white" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseSeven" aria-expanded="false" aria-controls="flush-collapseSeven">
