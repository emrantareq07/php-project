...
<?php include('includes/header.php');?>
 <div class="container text-center p-3 my-3 border shadow">
 	<h2 class="page-header text-success m-1 text-center badge bg-dark bg-outline-info text-wrap" style="width: 70rem; font-size: 30px;">View Service History of <b class="text-white">[<?php echo "Employee ID: ".$_SESSION['emp_id'];?>]</b>
...
echo "<table class='table table-bordered table-striped text-center'>";
    echo  '<thead class="thead-dark text-center">';
	  ...
	  echo  '<th class="text-center">From Date</th>';
		...
		echo  '<th class="text-center">Organization</th>';
        echo  '<th class="text-center">Location</th>';
        echo  '<th class="text-center">Place of Posting</th>';
