            ...
            <div class="col-md-12 col-sm-6 col-lg-6 col-xs-12">
                <div class="card shadow ">
                    <div class="card-header bg-dark">
                        <h4 class="text-uppercase text-white"><b>Welfare Grant Info. Edit </b>
                            <a href="welfare_info_details.php?emp_id=<?php echo $_SESSION['emp_id'] ?>" class="btn btn-danger float-end"><span class="glyphicon glyphicon-arrow-left" aria-hidden="true"></span> BACK</a>
                        </h4>
                    </div>
                    <div class="card-body">
                        ...
                        if(isset($_GET['id']))
                        {
                            ...
                            $query = "SELECT * FROM welfare_info WHERE id='$id' ";
                                ...
                                <form action="welfare_info-code.php" method="POST">
                                 ...
                                 <!--    <div class="mb-3">
                                    ...
                                    <div class="form-group mb-3"><label for="type">Welfare Grant Type:</label>
                                        ...
                                        <option value="Illness Grant" <?=$type == 'Illness Grant' ? ' selected="selected"' : '';?>>Illness Grant </option>
                                        <option value="Educational Grant" <?=$type == 'Educational Grant' ? ' selected="selected"' : '';?>>Educational Grant </option>
                                        <option value="Marriage Grant" <?=$type == 'Marriage Grant' ? ' selected="selected"' : '';?>>Marriage Grant </option>
                                        <option value="Retirement Grant" <?=$type == 'Retirement Grant' ? ' selected="selected"' : '';?>>Retirement Grant </option>
                                        <option value="Death Grant" <?=$type == 'Death Grant' ? ' selected="selected"' : '';?>>Death Grant </option>
                                        </select>
                                    </div>
