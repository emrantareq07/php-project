	...
	<div class="row">				
			...
			<div class="card-body">
				...
				<!-- <div class="input-group">
				  <div class="form-outline" data-mdb-input-init>
				    ...
				    <label class="form-label" for="form1">Institute Name</label>
				  </div> -->
				...
				<label for="ssc_board_or_univ">Board/Institute:</label>
				 <!-- <input class="form-control" placeholder="Enter Board" type="text" name="ssc_board_or_univ" id="ssc_board_or_univ" > -->

				 <!-- <select class="form-control" id="ssc_board_or_univ" name="ssc_board_or_univ" tabindex="" >
						<option value="" disabled selected>--Select--</option> -->
						<!-- <?php
						...
						//while($row = mysqli_fetch_array($result))
						{
						 //echo "<option value='".$row['id']."'>".$row['board']."</option>";
						}?>	 -->	
					 <!-- </select> -->
		...
		<!--Second Column-->
				...
				<label for="hsc_board_or_univ">Board/Institute:</label>
				 <!-- <input class="form-control" placeholder="Enter Board" type="text" name="hsc_board_or_univ" id="hsc_board_or_univ" > -->
				...
				<label for="hsc_div_or_cgpa">Division/Class/CGPA:</label>
				 <!-- <input class="form-control" placeholder="Enter Division/Class/CGPA" type="text" name="hsc_div_or_cgpa" id="hsc_div_or_cgpa" > -->
				 <select class="form-control" id="hsc_div_or_cgpa" name="hsc_div_or_cgpa" >
					...
					<!-- <input class="form-control" placeholder="Enter CGPA (Out of 4)" type="text" name="hsc_cgpa_4" id="hsc_cgpa_4"> -->
				...
				<label for="hsc_passing_year">Passing year</label>
				 <!-- <input class="form-control" placeholder="Enter Passing Year" type="text" name="hsc_passing_year" id="hsc_passing_year"> -->
				...
				<div class="form-group">
					...
					<label for="honors_group_name">Subject/Group/Degree:</label>
					 <!-- <input class="form-control" placeholder="Enter Group/Subject" type="text" name="honors_group_name" id="honors_group_name" > -->
            ...
            <select name="honors_inst_name" id="honors_inst_name" class="form-control">
				...
				<label for="honors_div_or_cgpa">Division/Class/CGPA:</label>
				 <!-- <input class="form-control" placeholder="Enter Division/Class/CGPA" type="text" name="honors_div_or_cgpa" id="honors_div_or_cgpa" > -->
				...
				<label for="honors_passing_year">Passing year</label>
				 <!-- <input class="form-control" placeholder="Enter Passing Year" type="text" name="honors_passing_year" id="honors_passing_year"> -->
