            ...
            <div class="col-md-12">
                <div class="card shadow-lg rounded border border-primary">
                    <div class="card-header">
                        <h4 class="text-center text-uppercase "><b>Welfare Information Details</b>
                            <a href="welfare_info-create.php" class="btn btn-primary float-end"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span> Add </a>
                        ...
                        <table class="table table-bordered table-striped">
                            <thead>
                                ...
                                <!-- <th>ID</th> -->
                                 ...
                                 <th>Ref. No.</th>
                                 <th>Granted Date</th>
                                 <th>Welfare Grant Type</th>
                                 
                                 <th>Grant Amount(TK.)</th>
                                 <th>Fiscal Year</th>
                            ...
                            <tbody>
                                ...
                                include('../db/db.php');
                                 ...
                                 if(isset($_SESSION['emp_id'])){
                                      ...
                                      $query="SELECT * FROM welfare_info where emp_id='$emp_id'";
                                     }
                                        ...
                                        foreach($query_run as $student)
                                        {
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    <a href="welfare_info-edit.php?id=<?= $student['id']; ?>" class="btn btn-success btn-sm"><span class="glyphicon glyphicon-edit"></span> </a>
                                                    <form action="welfare_info-code.php" method="POST" class="d-inline">
