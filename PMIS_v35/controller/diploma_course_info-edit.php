            ...
            <div class="col-md-12 col-sm-6 col-lg-6 col-xs-12">
                <div class="card shadow ">
                    <div class="card-header bg-dark">
                        <h4 class="text-uppercase text-white"><b>Diploma Course/Training Edit </b>
                            <a href="diploma_course_info_details.php?emp_id=<?php echo $_SESSION['emp_id'] ?>" class="btn btn-danger float-end"><span class="glyphicon glyphicon-arrow-left" aria-hidden="true"></span> BACK</a>
                        </h4>
                    </div>
                    <div class="card-body">
                        ...
                        if(isset($_GET['id']))
                        {
                            ...
                            $query = "SELECT * FROM diploma_course_info WHERE id='$id' ";
...
<!--                                     <div class="mb-3">
                                    ...
                                    <div class="form-group"><label for="type">Diploma Course Type:</label>
                                    <select class="form-control" id="type" name="type" >
                                        
                                    <option value="" disabled selected>--Select--</option>
                                         
                                    <option value="Local" <?=$type == 'Local' ? ' selected="selected"' : '';?> >Local</option>
                                    <option value="Foreign" <?=$type == 'Foreign' ? ' selected="selected"' : '';?> >Foreign</option>
                                    ...
                                    <div class="mb-3">
		                                <label>Grade:</label>
		                                <input type="text" name="grade" value="<?=$student['grade'];?>" placeholder="Enter Grade" class="form-control">
		                            </div>
                                    <div class="mb-3">
                                        <label>Period</label>
