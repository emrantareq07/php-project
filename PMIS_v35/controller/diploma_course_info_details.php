            ...
            <div class="col-md-12">
                <div class="card shadow-lg border-primary">
                    <div class="card-header">
                        <h4 class="text-center text-uppercase "><b>Diploma Course Information Details</b>
                            <a href="diploma_course_info-create.php" class="btn btn-primary float-end"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span> Add</a>
                            ...
                            <tbody>
                                <?php 
                                 ...
                                 if(isset($_SESSION['emp_id'])){
                                      ...
                                      $query="SELECT * FROM diploma_course_info where emp_id='$emp_id'";
                                     }
                                        ...
                                        foreach($query_run as $student)
                                        {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="diploma_course_info-edit.php?id=<?= $student['id']; ?>" class="btn btn-success btn-sm"><span class="glyphicon glyphicon-edit"></span> Edit</a>
                                                    <form action="diploma_course_info-code.php" method="POST" class="d-inline">
