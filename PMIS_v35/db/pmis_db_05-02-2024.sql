...
-- Dumped table `emp_bank_info` with 0 row(s)
--
...
-- Dumped table `prof_membership` with 0 row(s)
--
...
SET autocommit=0;
INSERT INTO `training_info` VALUES (1,0,'8118-2','Local Training','Computer Fundamentals & Its Appli.','TICI','Bangladesh','2 weeks','Jan\'2011');
/*!40000 ALTER TABLE `training_info` ENABLE KEYS */;
UNLOCK TABLES;
COMMIT;

-- Dumped table `training_info` with 1 row(s)
--
...
-- Dump completed on: Mon, 05 Feb 2024 10:39:08 +0100
