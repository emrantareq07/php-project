...
<div class="container-fluid p-2 my-1 border shadow  bg-white rounded">
...
<div class="col-sm-2 ">
     <a href="print_view_bio_data_at_a_glance_pdf.php?emp_id=<?php echo $_SESSION['emp_id'] ?>"  class="btn btn-warning float-end col-sm-2 "><i class="fa fa-print" aria-hidden="true"></i> Print </a>
</div>
<div class="col-sm-5 "></div>
    <!-- <button onclick="window.print();" class="btn btn-primary form-control float-end mt-5 btn-warning" id="print-btn"><i class="fa fa-print" aria-hidden="true"></i> Print</button>   -->
