...
$_SESSION['emp_id'];
// $_SESSION['seniority_no']=$_GET["seniority_no"];
// $_SESSION['seniority_no'];
// //$emp_id=$_SESSION['emp_id'];
// $seniority_no = $_SESSION['seniority_no'];
// echo $_SESSION['seniority_no']; 
// echo $seniority_no;
...
//Extend the TCPDF class to create custom Header and Footer
	...
	$obj_pdf = new MYPDF(PDF_PAGE_ORIENTATION, PDF_UNIT, PDF_PAGE_FORMAT, true, 'UTF-8', false);
      ...
      //$obj_pdf->SetHeaderData('SFCL LOGOv3.jpg', 'SFCL LOGOv3.jpg', PDF_HEADER_TITLE, PDF_HEADER_STRING); 
...
$obj_pdf->setTextShadow(array('enabled'=>true, 'depth_w'=>0.1, 'depth_h'=>0.1, 'color'=>array(196,196,196), 'opacity'=>1, 'blend_mode'=>'Normal'));
	...
	//for newline
	// $obj_pdf->Ln();
	// $obj_pdf->SetLineStyle(array('width' => 0.5, 'cap' => 'butt', 'join' => 'miter', 'dash' => 0, 'color' => array(255, 0, 255)));
// $obj_pdf->SetFillColor(0,255,0);
// $obj_pdf->SetTextColor(255,0,255);
// $obj_pdf->MultiCell(60, 4, $content, 1, 'C', 1, 1);
	//for image
	// set JPEG quality
...
//$obj_pdf->SetXY(20, 0);
//$obj_pdf->Image('image/bcic.jpg', '', '', 20, 20, '', '', 'T', false, 300, '', false, false, 1, false, false, false);
//$obj_pdf->Image('images/image_demo.jpg', '', '', 40, 40, '', '', '', false, 300, '', false, false, 1, false, false, false);
...
//for admin_fc	
 ...
 // echo $seniority_no;
	...
	//$result = mysqli_query($conn,"SELECT * FROM ajax_todo_tbl WHERE `date` LIKE '{$date}%'");
	  ...
	  // $div = '<p id="footer">wow this is a nice footer</p>'>
// $obj_pdf->Footer($div);
   ...
   //      
		 ...
		 //   <tr>  
   //              <th width="15%"><b>Month</b></th>  
   //              <th width="20%"><b>Commercial Office</b></th>  
   //              <th width="15%"><b>Foreign Purchase</b></th>  
   //              <th width="15%"><b>Local Purchase</b></th>  
   //              <th width="12%"><b>General Store</b></th>
			// 	<th width="20%"><b>Total Commercial</b></th>				
   //         </tr> 
   //    ';  
   //    $content .= fetch_data_com();  
   //    $content .= '</table>';  
...
//include 'database.php';
 ?>    <!-- <table border="1" cellspacing="0" cellpadding="5" align="center"> 
           <div class="container" style="width:700px;">  
                <h3 align="center">Daily Activity Report By Date</h3><br />  
			 ...
			 <a type="button" class="btn btn-dark" a href='/sfcl_fc/main.php'> Back to Home page</a>
			 </div>	
           </div>  -->
  <?php
//include('footer.php');
