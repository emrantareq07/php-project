...
<center>
       <?php 
    echo "<input class='rounded-circle border  border-muted' type=\"image\" name=\"imageField\" 
 width=\"100\" height=\"100\" src=\"".'../images/'.$row['image']."\">";
  }  ?>

          
        <button onclick="location.href='../view/view_profile_details.php?emp_id=<?php echo $_SESSION['emp_id'] ?>'" type="button" class="btn btn-info  text-center text-white" id="print-btn"><i class="fa fa-arrow-left" style="font-size:20px;color:white"></i>  </button>
      ...
      if($last_promo_date_db=='0000-00-00'){
       ...
       <?php
        ...
        echo "<table class='table table-bordered border table-hovered table-striped text-muted'>";
            // echo  '<thead >';
            echo '<tbody style="line-height: 1;" class="p-1">';

            echo '<tr >';
           echo '<tr >';
            echo '<td  class="table-success fw-bold  "> Name (BN)</td>';
            echo '<td class="">' . $row['name_bn'] . '</td>';
            echo '</tr>';


            echo '<tr>';
            echo '<th class="table-success ">Date of Birth</th>';
            echo '<td class="">' . $row['dob'] . '</td>';
            echo '</tr>';
            ...
            echo '<tr>';
            echo '<th class="table-success">Joining Date</th>';
            echo '<td>' . $row['doj'] . '</td>';
            echo '</tr>';
            ...
            echo '</tr>';
            echo '<tr>';
            echo '<th class="table-success" width="50%">Service Period (Current Designation)</th>';
