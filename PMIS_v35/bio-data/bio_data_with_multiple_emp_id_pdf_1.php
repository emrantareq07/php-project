...
<!-- <hr class="bg-warning" style="color:#1b4fa8;"> -->
 ...
 width=\"100\" height=\"100\" src=\"".'../images/'.$row['image']."\">&nbsp; </center>";
      ...
      <div class="col-sm-2"><!--2nd column-->
        ...
        <button onclick="location.href='bio_data_with_multiple_emp_id.php'" type="button" class="btn btn-info float-end mt-2 text-center text-white" id="print-btn"><i class="fa fa-arrow-left" style="font-size:20px;color:white"></i> Previous Page</button>
     ...
     if(isset($_POST['emp_id'])){
      ...
      $sql="SELECT * from service_history where emp_id='$emp_id' AND service_type='After Joining'";
       ...
       if (mysqli_num_rows($result) > 0) {
        ...
        <div class="">
            <h5 class="accordion-header text-center text-uppercase" id="flush-headingFive">
