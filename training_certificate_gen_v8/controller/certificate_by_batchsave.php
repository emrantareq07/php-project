...
// Fetch users + authority if batch is selected
$certificates = [];
if ($selected_batch) {
...
/* Outer wrapper for colorful gradient border */
.certificate-wrapper {
    width: 297mm; height: 210mm; /* A4 landscape */
    margin: auto;
    position: relative;
    page-break-after: always;
    /* Customize border widths here */
    padding: 20px 10px 20px 2px; /* top, right, bottom, left */
    background: linear-gradient(45deg, #2c3e50, #27ae60, #4a6491);
    border-radius: 20px;
    box-sizing: border-box;
}

/* Inner white certificate content */
.certificate-inner {
...
<div class="container">
    ...
    <div class="mb-3 text-end">
        <button onclick="downloadCertificates()" class="btn btn-success">Download All Certificates</button>
    </div>
    <?php endif; ?>
