...
<style>
  ...
  .product-urea { background-color: #e8f6f3; color: #16a085; }
  .product-dap { background-color: #fef9e7; color: #f39c12; }
  .product-npk { background-color: #f4ecf7; color: #8e44ad; }
  .product-sanitary { background-color: #eaf2f8; color: #3498db; }
  .product-insulator { background-color: #f9ebea; color: #c0392b; }
  .product-refractories { background-color: #e8f8f5; color: #1abc9c; }
...
<div class="container-fluid my-0 border shadow rounded p-4 bg-light"> 
  ...
  <div class="row align-items-center gradient-header mb-4">
