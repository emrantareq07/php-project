...
if (isset($_SESSION['preferred_view'])) {
...
function saveViewPreference(view) {
    // You can use AJAX to save to server session or use localStorage
    localStorage.setItem('bcic_preferred_view', view);
    
    // Optional: Send to server via AJAX to persist across page reloads
    /*
    var xhr = new XMLHttpRequest();
    xhr.open('POST', 'save_view_preference.php', true);
...
function initializeView() {
    ...
    const screenView = detectScreenSize();
    
    let defaultView = '<?php echo $default_view; ?>';
    
    // Use saved preference if exists, otherwise use device detection
    if (savedView) {
        defaultView = savedView;
    } else {
        defaultView = screenView;
    }
...
<div id="printableArea_ind_tenants_aa" class="mb-0 m-0 p-0">
    ...
    <div class="view-toggle">
        <button id="table-btn" class="view-toggle-btn" onclick="toggleView('table')">
