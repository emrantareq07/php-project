...
<div class="container-fluid py-0">
    <div class="worker-section">
        ...
        <div class="header-info">
            <div class="row">
                <div class="col-md-6">
                    <h5><i class="fas fa-hard-hat"></i> Ansar Information</h5>
                </div>
                <div class="col-md-6 text-end">
                    <div class="row">
                        ...
                        <?php if ($role == 'admin') { ?>
                          ...
                          <a href="ansar_details.php" class="btn btn-primary btn-sm">
                            ...
                            <tr class="worker-row">
                                ...
                                <td>
                                    <input type="number" class="form-control sanctioned-post" name="sanctioned_post[]" 
                                           min="0" value="<?php echo $sanctioned_posts[$i] ?? 0; ?>" >
                                </td>
                                <td>
    ...
    <div class="card records-table">
        <div class="card-header bg-light">
            <div class="row align-items-center">
                <div class="col-md-6">
                    <h5 class="mb-0"><i class="fas fa-database"></i> Ansar Records</h5>
                </div>
                <div class="col-md-6 text-end">
...
$(document).ready(function() {
        ...
        $.ajax({
            ...
            success: function(response) {
                if (response.success) {
                    ...
                    window.location.href = 'ansar_info.php';
                } else {
    ...
    function checkMonthlyRestriction() {
        ...
        $.ajax({
            url: 'check_monthly_entry_ansar.php',
            type: 'POST',
            data: { 
                date: date,
    ...
    $(document).on('click', '.edit-btn', function() {
        ...
        window.location.href = 'ansar_info.php?edit_id=' + id;
    });

    // Load button behavior
    $(document).on('click', '.load-btn', function() {
        const id = $(this).data('id');
        window.location.href = 'ansar_info.php?load_id=' + id;
    });
...
// View Record function (for print report) - FIXED VERSION
    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            if (response.success) {
                ...
                content += `
                    <div class="mt-4">
                        <h5 class="text-center">আনছার সদস্যদের তালিকা</h5>
        ...
        error: function(xhr, status, error) {
            ...
            alert('Error loading record details. Please check if get_worker_data1.php exists and check console for details.');
        }
    });
}
