...
-- Date: Mon, 29 Apr 2024 08:58:32 +0200
...
SET autocommit=0;
INSERT INTO `jfcl` VALUES (1,'jfcl',20231,'2023-07-04',60,60,60,450000,449980,80,''),(2,'jfcl',202410,'2024-04-28',20,20,80,450000,449970,80,'');
...
SET autocommit=0;
INSERT INTO `target_table` VALUES (1,'sfcl',4000,'2023-07-01','2024-06-30'),(2,'jfcl',2000,'2023-07-01','2024-06-30'),(3,'sfcl',3000,'2024-07-01','2025-06-30'),(4,'sfcl',500000,'2023-07-05','2024-06-30');
/*!40000 ALTER TABLE `target_table` ENABLE KEYS */;
UNLOCK TABLES;
COMMIT;

-- Dumped table `target_table` with 4 row(s)
--
...
-- Dump completed on: Mon, 29 Apr 2024 08:58:32 +0200
