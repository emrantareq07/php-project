                        ...
                        <form action="edit_urea_code.php" method="POST">
                            ...
                            ?>
                                <select class="form-control" name="product_produce" id="product_produce">
                                    <option value="sanitary" <?php echo ($row['product_produce'] == 'sanitary') ? 'selected' : ''; ?>>Sanitary</option>
                            ...
                            ?>
                                <input type="text" class="form-control" name="product_produce" 
                                       value="<?php echo !empty($row['product_produce']) ? htmlspecialchars($row['product_produce']) : ''; ?>">
                            <?php
                            }
                            ?>
