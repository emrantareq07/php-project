...
-- Date: Sun, 05 May 2024 10:45:16 +0200
...
SET autocommit=0;
INSERT INTO `afccl` VALUES (1,'afccl',202312,'2023-06-01','10','20','20','50000','','',''),(3,'afccl',20231,'2023-07-01','10','10','10','','','',''),(5,'afccl',202411,'2024-05-05','30','30','40','','-40','','');
/*!40000 ALTER TABLE `afccl` ENABLE KEYS */;
UNLOCK TABLES;
COMMIT;

-- Dumped table `afccl` with 3 row(s)
--
...
SET autocommit=0;
INSERT INTO `jfcl` VALUES (1,'jfcl',20231,'2023-07-04',60,60,60,450000,449980,80,''),(2,'jfcl',202410,'2024-04-28',20,20,80,0,0,80,''),(3,'jfcl',202411,'2024-05-02',10,10,90,0,-90,0,''),(8,'jfcl',202411,'2024-05-05',30,40,120,0,-120,0,'');
/*!40000 ALTER TABLE `jfcl` ENABLE KEYS */;
UNLOCK TABLES;
COMMIT;

-- Dumped table `jfcl` with 4 row(s)
--
...
SET autocommit=0;
INSERT INTO `target_table` VALUES (5,'sfcl',400000,'2023-07-01','2024-06-30'),(6,'jfcl',0,'2023-07-01','2024-06-30'),(7,'jfcl',0,'2024-07-01','2025-06-30'),(8,'afccl',400000,'2023-07-01','2024-06-30'),(9,'tici',0,'2023-07-01','2024-06-30');
/*!40000 ALTER TABLE `target_table` ENABLE KEYS */;
UNLOCK TABLES;
COMMIT;

-- Dumped table `target_table` with 5 row(s)
--
...
SET autocommit=0;
INSERT INTO `users` VALUES (1,'sfcl','40bd001563085fc35165329ea1ff5c5ecbdbbeef','user','','2022-12-30 16:12:35'),(2,'jfcl','40bd001563085fc35165329ea1ff5c5ecbdbbeef','user','','2023-02-21 16:20:41'),(3,'afccl','40bd001563085fc35165329ea1ff5c5ecbdbbeef','user','','2022-12-30 16:54:22'),(4,'emran','40bd001563085fc35165329ea1ff5c5ecbdbbeef','admin','','2023-02-21 06:50:15'),(5,'tici','40bd001563085fc35165329ea1ff5c5ecbdbbeef','user','user@yahoo.com','2024-05-05 05:50:42');
...
-- Dump completed on: Sun, 05 May 2024 10:45:16 +0200
