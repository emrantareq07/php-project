...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 06, 2023 at 01:05 PM
...
INSERT INTO `admin_login` (`id`, `username`, `password`, `fullname`) VALUES
...
INSERT INTO `afccl` (`id`, `factory_name`, `date`, `daily`, `monthly`, `yearly`, `production_target`, `due`, `plant_load`, `stock_on_date`, `remarks`, `created_at`, `modified_at`) VALUES
(1, 'afccl', '2023-06-01', '10', '20', '20', '50000', '', '', '', '', NULL, '2023-06-08 08:52:41');
...
INSERT INTO `jfcl` (`id`, `month_id`, `date`, `daily`, `monthly`, `yearly`, `production_target`, `due`, `plant_load`, `remarks`) VALUES
(1, 20231, '2023-07-04', 20, 20, 20, 450000, 449980, 80, '');
...
INSERT INTO `sfcl` (`id`, `month_id`, `date`, `daily`, `monthly`, `yearly`, `production_target`, `due`, `plant_load`, `remarks`) VALUES
(1, 20231, '2023-07-01', 10, 10, 10, 450000, 449990, 80, ''),
(2, 20231, '2023-07-04', 20, 30, 30, 450000, 449970, 80, ''),
(3, 20231, '2023-07-05', 0, 30, 30, 450000, 449970, 80, 'Due Low NG pressure '),
(4, 20231, '2023-07-07', 20, 50, 50, 450000, 449950, 80, '');
...
(1, 'sfcl', 4000, '2023-07-01', '2024-06-30'),
(2, 'jfcl', 2000, '2023-07-01', '2024-06-30'),
(3, 'sfcl', 3000, '2024-07-01', '2025-06-30'),
(4, 'sfcl', 500000, '2023-07-05', '2024-06-30');
...
(4, 'emran', '40bd001563085fc35165329ea1ff5c5ecbdbbeef', 'admin', '', '2023-02-21 06:50:15');
