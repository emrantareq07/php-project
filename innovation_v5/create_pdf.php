...
<h1 style="text-align: center; text-transform:uppercase;padding-top: -120px;">বাংলাদেশ কেমিক্যাল ইন্ডাস্ট্রিজ কর্পোরেশন </h1>
...
<table width="100%" style="vertical-align: bottom; font-family: serif; 
    ...
    <tr>
        ...
        <td width="33%" style="text-align: right;">Innovation Database</td>
		<td width="33%"><span style="font-weight: bold; font-style: italic;"> [Design & Developed by Md. Tareq Emran, Programmer]</span></td>
...
//     <tr>
// 		<td width="33%" style="text-align: right;">Innovation Database</td>
//         <td width="33%"><span style="font-weight: bold; font-style: italic;">Innovation Database Design & Developed by Md. Tareq Emran, Programmer.</span></td>
