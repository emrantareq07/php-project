...
$ext = strtolower(pathinfo($_FILES['image_befor_after_inno']['name'],PATHINFO_EXTENSION));
$size = $_FILES['image_befor_after_inno']['size'];

if(!in_array($ext,$allowed)){
throw new Exception("Only JPG, PNG allowed for image");
}
...
$ext = strtolower(pathinfo($_FILES['flowchart']['name'],PATHINFO_EXTENSION));
$size = $_FILES['flowchart']['size'];

if(!in_array($ext,$allowed)){
throw new Exception("Only JPG, PNG, PDF allowed for flowchart");
}

if($size > $maxsize){
throw new Exception("Flowchart must be less than 10MB");
}

$filename = $emp_id."_".$fy_tag."_flowchart_".time().".".$ext;

$upload_path = $flow_dir.$filename;
 ...
 <!-- Innovation Details -->
    ...
    <div class="row g-3">
        ...
        <div class="col-md-6">
            ...
            <input type="file" name="image_befor_after_inno" id="imageUpload" class="form-control">
        ...
        <div class="col-md-6">
            ...
            <input type="file" name="flowchart" id="flowUpload" class="form-control">
            <iframe id="pdfPreview" style="width:300px;height:200px;display:none;"></iframe>
        </div>
...
document.getElementById("flowUpload").onchange = function(evt){
