    ...
    var table = $('#friendsTable').DataTable({
        ...
        columns: [
            ...
            { 
                ...
                render: function(row){
                    return `
                        <button class="btn btn-sm btn-outline-warning editBtn" data-bs-toggle="tooltip" title="Edit"  data-id="${row.id}"><i class="fa fa-edit"></i></button>
                        <button class="btn btn-sm btn-outline-success approveBtn" data-bs-toggle="tooltip" title="Approved" data-id="${row.id}"><i class="fa fa-check"></i></button>
                        <a href="delete.php?id=${row.id}" class="btn btn-sm btn-outline-danger" onclick="return confirm('Delete this record?')" data-bs-toggle="tooltip" title="Delete Contact" ><i class="fa fa-trash"></i></a>
                    `;
                }
            }
        ],
