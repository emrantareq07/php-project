...
<body>
    ...
    <div class="container py-2">
        <div class="row justify-content-center">
            <div class="col-12">
                <!-- Header Card -->
                <div class="card glass-card border-0 mb-2 overflow-hidden">
                    ...
                    <div class="card-body p-4">
                        ...
                        <form id="workRequestForm" method="POST">
                            ...
                            <div class="form-section mb-2">
                                <h5 class="mb-2 border-bottom pb-2 text-primary">
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <textarea class="form-control" id="w_description" name="w_description" 
                                                  ...
                                                  rows="3" required><?php echo htmlspecialchars($_POST['w_description'] ?? ''); ?></textarea>
                            ...
                            <div class="form-section mb-2">
                                ...
                                <div class="row g-3">
                                    <div class="col-12">
                                        <div class="alert alert-warning border-warning bg-light mb-2">
                                            <div class="d-flex">
    ...
    <!-- Add / Edit Modal for transport request -->
<div class="modal fade" id="transportModal" tabindex="-1">
  <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
    <div class="modal-content border-0 shadow-lg">
      <div class="modal-header bg-primary text-white">
        <h5 class="modal-title fw-bold">🚐 Transport Work Request</h5>
        ...
        <div class="modal-body">
          <div class="row g-3">
            ...
            <div class="col-md-3">
              ...
              <input type="number" name="no_of_visitor" class="form-control" required>
            </div>

            <div class="col-md-6">
              <label class="form-label">Visiting Place</label>
              <input type="text" name="visiting_place" class="form-control" required>
            </div>
            ...
            <div class="col-md-4">
              ...
              <input type="text" name="reporting_place" class="form-control">
            </div>

            <div class="col-md-4">
              <label class="form-label">Visiting Type</label>
              <select name="visiting_type" class="form-select">
            ...
            <div class="col-md-4">
              <label class="form-label">Vehicle Provide</label>
              <select name="v_provide_status" class="form-select">
