...
// For IT Section Heads, if no specific status is selected and no status filter in URL, default to 'incomplete'
if ($isITSectionHead && isset($_GET['status']) && $status_filter === 'all') {
