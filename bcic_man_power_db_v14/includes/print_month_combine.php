...
<head>
    <meta charset="UTF-8">
    <title>শূন্য পদ পরিসংখ্যান - <?php echo $month_name_bn; ?></title>
...
<div class="print-header">
    ...
    <h5>মাস: <?php echo $month_name_bn . ' ' . $year_bn; ?></h5>
    <p>প্রতিবেদন তৈরির তারিখ: <?php echo enToBn(date('d-m-Y')); ?></p>
</div>
    ...
    <table class="print-table">
        <thead>
            <tr>
                ...
                <th style="width: 16%">মোট শূন্য পদ</th>
                <th style="width: 14%">পদোন্নতিযোগ্য শূন্যপদ</th>
                <th style="width: 14%">সরাসরি নিয়োগযোগ্য শূন্যপদ</th>
...
<div class="row mt-0">
           <div class="col-md-12 text-center">
            ...
            <small class="text-muted text-center" style="border-top: 1px solid #dee2e6;  margin-top: 5px;">
...
<div class="text-center mt-2">
    <small class="text-muted bangla-number">প্রতিবেদন তৈরির তারিখ: <?php echo enToBn(date('d-m-Y')); ?></small>
</div>
