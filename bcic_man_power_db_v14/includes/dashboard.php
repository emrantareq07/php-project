...
<div class="sidebar d-flex flex-column" id="sidebar">
    ...
    <a href="change_password.php"><i class="fa fa-cogs me-2"></i>Change Password</a>
...
<div class="main-content" id="mainContent">
    <div class="container-fluid">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h4 class="text-uppercase">স্বাগতম, <?= htmlspecialchars($username) ?>!</h4>
            <span class="akaya-kanadaka-regular bg-primary px-3 py-1 rounded text-white d-inline-block">
                <i class="fa fa-copyright me-2"></i> <?php echo date("Y");?>  BCIC. [--Design & Developed by ICT Division, BCIC.--]
            </span>
        ...
        <div class="row g-4 mb-4">
            ...
            <div class="col-md-4">
                <div class="card p-3 text-center text-white bg-<?= $c['bg'] ?>">
                    ...
                    <div class="entry-count text-white">
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-striped text-center">
                    <thead class="table-primary">
                        <tr>
                            <th class="text-start">ক্যাটাগরি ভিত্তিক</th>
                            <th>এন্ট্রি সংখ্যা</th>
                            <th>পুরুষ (কর্মরত)</th>
                            <th>মহিলা (কর্মরত)</th>
                            <th>মোট জনবল (কর্মরত)</th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php
                ...
                <table class="table table-hover mb-0">
                    <thead style="background: #e9ecef;">
                        <tr>
                            ...
                            <th>মাস/বছর</th>
                            <th>মোট অনুমোদিত পদ</th>
                            <th>মোট কর্মরত </th>
                            <th>মোট শূন্য পদ</th>
                            <th>পদোন্নতিযোগ্য শূন্য পদ</th>
                            <th>সরাসরি নিয়োগযোগ্য শূন্য পদ</th>
                            <!-- <th>অ্যাকশন</th> -->
                        </tr>
                    </thead>
                    <tbody class="text-center">
                        <?php if (count($vacant_records) > 0): ?>
                            ...
                            <tr>
                                <td><?= $record['id'] ?></td>
                                <td>
                                    <strong class="text-uppercase"><?= htmlspecialchars($record['factory_name']) ?></strong>
