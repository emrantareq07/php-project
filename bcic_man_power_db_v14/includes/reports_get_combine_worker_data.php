...
$table_check = $conn->query("SHOW TABLES LIKE 'workers_tbl'");
if ($table_check->num_rows == 0) {
    echo json_encode(['success' => false, 'message' => 'workers_tbl table does not exist in database']);
    exit;
}

// Query for worker data - using same structure as staff
$query = "SELECT 
            id, 
            factory_name, 
            date, 
