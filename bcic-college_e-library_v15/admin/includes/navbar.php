            ...
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="categoriesDropdown">
                        <li><a class="dropdown-item" href="add-category.php"><i class="fas fa-plus-circle me-1"></i> Add Category</a></li>
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="authorsDropdown">
                        <li><a class="dropdown-item" href="add-author.php"><i class="fas fa-plus-circle me-1"></i> Add Author</a></li>
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="booksDropdown">
                        <li><a class="dropdown-item" href="add-book.php"><i class="fas fa-plus-circle me-1"></i> Add Book</a></li>
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="#" id="issueDropdown" role="button" 
                       data-bs-toggle="dropdown" aria-expanded="false">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="reg-students.php"><i class="fas fa-users me-1"></i> Registered Students</a>
                </li>
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="settingsDropdown">
                        <li><a class="dropdown-item" href="inactive_process.php"><i class="fas fa-power-off me-1"></i> Inactive/Active Process</a></li>
                        <li>
                            <form id="downloadForm" action="dawnload_database.php" method="post" class="px-2">
