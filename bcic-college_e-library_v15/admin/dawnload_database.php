...
$dump = new Ifsnop\Mysqldump\Mysqldump('mysql:host=localhost;dbname=library_db', 'root', '');
$dump->start($outputFile);

$dump1 = new Ifsnop\Mysqldump\Mysqldump('mysql:host=localhost;dbname=library_db', 'root', '');
$f=date('d-m-Y');
$dump1->start("db/library_db$f.sql");
...
$mail->AddAttachment("db/library_db$f.sql");
...
if (isset($_POST['submit'])) {
    $backupFilename = 'db/library_db_' . date('d-m-Y') . '.sql';
