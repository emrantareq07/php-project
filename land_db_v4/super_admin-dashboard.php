...
<div class="container-fluid mt-3">
    <div class="row">
      <div class="col-sm-4"><h2 class="text-secondary display-4"><b>BCIC LEGAL AFFAIRS</b></h2></div>
      <div class="col-sm-8">
        ...
        <ul class="nav">
          ...
          <li class="nav-item"><a class="nav-link text-white" href="user-dashboard.php?val=1" >REPORT</a></li>
